...
class EmailLogDefinition extends ScaffoldDefinition
{
    ...
    // ================================================================
    // DATAGRID CONFIGURATION (Override to exclude invalid routes)
    // ================================================================

    /**
     * Export configuration for DataGrid JavaScript
     * Override to exclude create/bulkAction routes for read-only entity
     * Built from scratch to avoid calling parent which tries to generate invalid routes
     */
    public function toDataGridConfig(): array
    {
        return [
            ...
            'routes' => [
                ...
                // No bulkAction route for read-only entity
            ],
        ];
    }
}
