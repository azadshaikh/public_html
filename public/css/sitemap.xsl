...
>
				...
				<tbody>
                    ...
                    <xsl:for-each select="sitemap:sitemapindex/sitemap:sitemap">
						<tr>
                            ...
                            <td class="datetime"><xsl:value-of select="concat(substring(sitemap:lastmod,0,11),concat(' ', substring(sitemap:lastmod,12,5)))"/></td>
					    </tr>
				    </xsl:for-each>
				</tbody>
			</table>
	...
	<xsl:template name="Header">
        ...
        <div id="content-head">
            ...
            <p>This is an XML Sitemap, meant to be consumed by search engines like Google or Bing.</p>
            ...
            <!-- <p>Powered by <a href="https://astero.in/" target="_blank" rel="noreferrer noopener">Astero</a>.</p> -->
        </div>
    </xsl:template>
    ...
    <xsl:template name="emptySitemap">
        <div class="breadcrumb">
            ...
            <a href="https://bee.breederspot.site"><span>Home</span></a>
        ...
        <div class="empty-sitemap">
            <h2 class="empty-sitemap__title">
                Whoops!			<br />
                There are no Sitemap here		</h2>
            <div class="empty-sitemap__buttons">
                <a href="/" class="button">Back to Homepage</a>
            </div>

            <div class="aioseo-alert text-primary">
                Didn't expect to see this? Make sure your sitemap is enabled and your content is set to be indexed.
            </div>
        </div>
        <style>
            .hand-magnifier{
