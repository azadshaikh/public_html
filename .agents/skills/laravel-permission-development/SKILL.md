...
description: Build and work with Spatie Laravel Permission features, including roles, permissions, middleware, policies, teams, and Blade directives. Use when working with authorization, roles, permissions, access control, middleware guards, or Blade permission directives using spatie/laravel-permission.
---
