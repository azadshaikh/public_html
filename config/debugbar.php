...
return [
    ...
    */
    ...
    'collectors' => [
        ...
        'cache' => env('DEBUGBAR_COLLECTORS_CACHE', true),            // Display cache events (disabled by default; can crash route generation)
    ...
    'options' => [
        ...
        'cache' => [
            ...
            'timeline' => env('DEBUGBAR_OPTIONS_CACHE_TIMELINE', true),  // Add mails to the timeline
        ],
        'http_client' => [
            'masked' => [],
