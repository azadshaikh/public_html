...
type CheckboxCollectionProps = {
    ...
    options: MovieOption[];
    error?: string;
    onToggle: (field: MultiSelectField, value: string, checked: boolean) => void;
};
...
export default function MovieForm({
    ...
    const handleFileChange = (field: 'poster' | 'backdrop', file: File | null) => {
            ...
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1.8fr)_minmax(320px,1fr)]">
                <div className="grid gap-6">
                    <Card>
                        ...
                        <CardContent className="grid gap-6">
                            <FieldGroup>
                                ...
                                <Field data-invalid={Boolean(form.errors.slug)}>
                                    ...
                                    <InputGroup className="w-full">
                                        <InputGroupAddon>
                                            <InputGroupText>demo/movies/</InputGroupText>
                                        </InputGroupAddon>
                                        <InputGroupInput
                                            id="slug"
                                            value={form.data.slug}
                                            onChange={(event) =>
                                                handleTextChange('slug', slugify(event.target.value))
                                            }
                                            aria-invalid={Boolean(form.errors.slug) || undefined}
                                            placeholder="the-midnight-circuit"
                                        />
                                    </InputGroup>
                                    <FieldDescription>
                                        Auto-generated from the title until you edit it.
                                    </FieldDescription>
                            ...
                            <FieldGroup>
                                <Field data-invalid={Boolean(form.errors.tagline)}>
                                    <FieldLabel htmlFor="tagline">Tagline</FieldLabel>
                                    <Input
                                        id="tagline"
                                        value={form.data.tagline}
                                        onChange={(event) =>
                                            handleTextChange('tagline', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.tagline) || undefined}
                                        placeholder="A neon-soaked chase through a city that never sleeps"
                                    />
                                    <FieldError>{form.errors.tagline}</FieldError>
                                </Field>

                                <Field data-invalid={Boolean(form.errors.director)}>
                                    <FieldLabel htmlFor="director">Director</FieldLabel>
                                    <Input
                                        id="director"
                                        value={form.data.director}
                                        onChange={(event) =>
                                            handleTextChange('director', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.director) || undefined}
                                        placeholder="Jordan Vega"
                                    />
                                    <FieldError>{form.errors.director}</FieldError>
                                </Field>
                            </FieldGroup>

                            <FieldGroup>
                                <Field data-invalid={Boolean(form.errors.synopsis)}>
                                    ...
                                    <Textarea
                                        ...
                                        aria-invalid={Boolean(form.errors.synopsis) || undefined}
                                        placeholder="Describe the plot, stakes, and why the audience should care."
                                        rows={6}
                                    />
                                    <FieldDescription>
                                        Use this large textarea to test multi-paragraph content.
                                    </FieldDescription>
                                    <FieldError>{form.errors.synopsis}</FieldError>
                                </Field>

                                <Field data-invalid={Boolean(form.errors.notes)}>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid gap-6">
                            <FieldGroup className="md:grid-cols-2">
                                <Field data-invalid={Boolean(form.errors.release_date)}>
                                    ...
                                    <Input
                                        ...
                                        onChange={(event) =>
                                            handleTextChange('release_date', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.release_date) || undefined}
                                    />
                                    <FieldError>{form.errors.release_date}</FieldError>
                                </Field>

                                <Field data-invalid={Boolean(form.errors.release_time)}>
                                    <FieldLabel htmlFor="release_time">Premiere time</FieldLabel>
                                    <Input
                                        id="release_time"
                                        type="time"
                                        value={form.data.release_time}
                                        onChange={(event) =>
                                            handleTextChange('release_time', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.release_time) || undefined}
                                    />
                                    <FieldError>{form.errors.release_time}</FieldError>
                                </Field>
                            </FieldGroup>

                            <FieldGroup className="md:grid-cols-3">
                                <Field data-invalid={Boolean(form.errors.runtime_minutes)}>
                                    <FieldLabel htmlFor="runtime_minutes">Runtime (minutes)</FieldLabel>
                                    <Input
                                        id="runtime_minutes"
                                        type="number"
                                        min={45}
                                        ...
                                        onChange={(event) =>
                                            handleTextChange('runtime_minutes', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.runtime_minutes) || undefined}
                                        placeholder="124"
                                    />
                                    <FieldError>{form.errors.runtime_minutes}</FieldError>
                                </Field>

                                <Field data-invalid={Boolean(form.errors.metascore)}>
                                    <FieldLabel htmlFor="metascore">Metascore</FieldLabel>
                                    <Input
                                        id="metascore"
                                        type="number"
                                        min={0}
                                        ...
                                        onChange={(event) =>
                                            handleTextChange('metascore', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.metascore) || undefined}
                                        placeholder="79"
                                    />
                                    <FieldError>{form.errors.metascore}</FieldError>
                                </Field>

                                <Field data-invalid={Boolean(form.errors.audience_score)}>
                                    <FieldLabel htmlFor="audience_score">Audience score</FieldLabel>
                                    <Input
                                        id="audience_score"
                                        type="number"
                                        min={0}
                                        ...
                                        onChange={(event) =>
                                            handleTextChange('audience_score', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.audience_score) || undefined}
                                        placeholder="92"
                                    />
                                    <FieldError>{form.errors.audience_score}</FieldError>
                                </Field>
                            </FieldGroup>

                            <FieldGroup className="md:grid-cols-3">
                                <Field data-invalid={Boolean(form.errors.imdb_rating)}>
                                    <FieldLabel htmlFor="imdb_rating">IMDb rating</FieldLabel>
                                    <Input
                                        id="imdb_rating"
                                        type="number"
                                        min={0}
                                        ...
                                        onChange={(event) =>
                                            handleTextChange('imdb_rating', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.imdb_rating) || undefined}
                                        placeholder="8.4"
                                    />
                                    <FieldError>{form.errors.imdb_rating}</FieldError>
                                </Field>

                                <Field data-invalid={Boolean(form.errors.ticket_price)}>
                                    <FieldLabel htmlFor="ticket_price">Average ticket price</FieldLabel>
                                    <Input
                                        id="ticket_price"
                                        type="number"
                                        min={0}
                                        ...
                                        onChange={(event) =>
                                            handleTextChange('ticket_price', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.ticket_price) || undefined}
                                        placeholder="18.50"
                                    />
                                    <FieldError>{form.errors.ticket_price}</FieldError>
                                </Field>

                                <Field data-invalid={Boolean(form.errors.language)}>
                                    <FieldLabel htmlFor="language">Original language</FieldLabel>
                                    <NativeSelect
                                        id="language"
                                        className="w-full"
                                        value={form.data.language}
                                        onChange={(event) =>
                                            handleTextChange('language', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.language) || undefined}
                                    >
                                    ...
                                    <FieldError>{form.errors.language}</FieldError>
                                </Field>
                            </FieldGroup>

                            <FieldGroup className="md:grid-cols-3">
                                <Field data-invalid={Boolean(form.errors.budget)}>
                                    <FieldLabel htmlFor="budget">Production budget</FieldLabel>
                                    <Input
                                        id="budget"
                                        type="number"
                                        min={0}
                                        ...
                                        onChange={(event) =>
                                            handleTextChange('budget', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.budget) || undefined}
                                        placeholder="150000000"
                                    />
                                    <FieldError>{form.errors.budget}</FieldError>
                                </Field>

                                <Field data-invalid={Boolean(form.errors.box_office)}>
                                    <FieldLabel htmlFor="box_office">Worldwide box office</FieldLabel>
                                    <Input
                                        id="box_office"
                                        type="number"
                                        min={0}
                                        ...
                                        onChange={(event) =>
                                            handleTextChange('box_office', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.box_office) || undefined}
                                        placeholder="480000000"
                                    />
                                    <FieldError>{form.errors.box_office}</FieldError>
                                </Field>

                                <Field data-invalid={Boolean(form.errors.studio)}>
                                    <FieldLabel htmlFor="studio">Studio</FieldLabel>
                                    <Input
                                        id="studio"
                                        value={form.data.studio}
                                        onChange={(event) =>
                                            handleTextChange('studio', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.studio) || undefined}
                                        placeholder="North Star Pictures"
                                    />
                                    <FieldError>{form.errors.studio}</FieldError>
                                </Field>
                            </FieldGroup>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>Classification and discoverability</CardTitle>
                            <CardDescription>
                                Use toggles and multi-select fields to test different input types.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-6">
                            <FieldSet>
                                ...
                                <FieldDescription>
                                    Choose the publishing state used by the demo listing filters.
                                </FieldDescription>
                                <ToggleGroup
                                    type="single"
                                    variant="outline"
                            ...
                            <FieldSet>
                                ...
                                <FieldDescription>
                                    Compact toggle buttons are useful for small option sets.
                                </FieldDescription>
                                <ToggleGroup
                                    type="single"
                                    variant="outline"
                ...
                <div className="grid gap-6">
                    <Card>
                        ...
                        <CardContent className="grid gap-6">
                            <FieldGroup>
                                <Field data-invalid={Boolean(form.errors.trailer_url)}>
                                    <FieldLabel htmlFor="trailer_url">Trailer URL</FieldLabel>
                                    <InputGroup className="w-full">
                                        <InputGroupAddon>
                                        ...
                                        <InputGroupInput
                                            id="trailer_url"
                                            value={trimProtocol(form.data.trailer_url)}
                                            onChange={(event) =>
                                                handleTextChange(
                                                    'trailer_url',
                                                    event.target.value === ''
                                            ...
                                            aria-invalid={Boolean(form.errors.trailer_url) || undefined}
                                            placeholder="youtube.com/watch?v=demo123"
                                        />
                                    </InputGroup>
                                    <FieldError>{form.errors.trailer_url}</FieldError>
                                </Field>

                                <Field data-invalid={Boolean(form.errors.official_site)}>
                                    <FieldLabel htmlFor="official_site">Official site</FieldLabel>
                                    <Input
                                        id="official_site"
                                        type="url"
                                        value={form.data.official_site}
                                        onChange={(event) =>
                                            handleTextChange('official_site', event.target.value)
                                        }
                                        aria-invalid={Boolean(form.errors.official_site) || undefined}
                                        placeholder="https://midnightcircuit.example"
                                    />
                                    <FieldError>{form.errors.official_site}</FieldError>
                                </Field>
                            </FieldGroup>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Upload poster and backdrop images to validate file handling.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-6">
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="grid gap-3">
                                    <MovieArtwork
                                        ...
                                        variant="poster"
                                    />
                                    <Field data-invalid={Boolean(form.errors.poster)}>
                                        <FieldLabel htmlFor="poster">Poster image</FieldLabel>
                                        <Input
                                            id="poster"
                                            type="file"
                                            accept="image/*"
                                            ...
                                            aria-invalid={Boolean(form.errors.poster) || undefined}
                                        />
                                        <FieldError>{form.errors.poster}</FieldError>
                                    </Field>
                                    {movie?.poster_url && (
                                        <Field orientation="horizontal">
                                            <Switch
                                                checked={form.data.remove_poster}
                                            ...
                                            <FieldContent>
                                                ...
                                                <FieldDescription>
                                                    Useful when testing replacement and deletion flows.
                                                </FieldDescription>
                                            </FieldContent>
                                        </Field>
                                    )}
                                ...
                                <div className="grid gap-3">
                                    <MovieArtwork
                                        ...
                                        variant="backdrop"
                                    />
                                    <Field data-invalid={Boolean(form.errors.backdrop)}>
                                        <FieldLabel htmlFor="backdrop">Backdrop image</FieldLabel>
                                        <Input
                                            id="backdrop"
                                            type="file"
                                            accept="image/*"
                                            ...
                                            aria-invalid={Boolean(form.errors.backdrop) || undefined}
                                        />
                                        <FieldError>{form.errors.backdrop}</FieldError>
                                    </Field>
                                    {movie?.backdrop_url && (
                                        <Field orientation="horizontal">
                                            <Switch
                                                checked={form.data.remove_backdrop}
                                                onCheckedChange={(checked) =>
                                                    toggleBoolean(
                                                        'remove_backdrop',
                                                        checked === true,
                                            ...
                                            <FieldContent>
                                                ...
                                                <FieldDescription>
                                                    Lets you test media removal without uploading a replacement.
                                                </FieldDescription>
                                            </FieldContent>
                                        </Field>
                                    )}
                        ...
                        <CardContent className="grid gap-4">
                            <Field orientation="horizontal">
                                <Switch
                                    ...
                                    onCheckedChange={(checked) =>
                                        toggleBoolean('is_featured', checked === true)
                                    }
                                />
                                <FieldContent>
                                    <FieldLabel>Featured title</FieldLabel>
                                    <FieldDescription>
                                        Highlight this movie in the demo listing.
                                    </FieldDescription>
                                </FieldContent>
                            </Field>
                            ...
                            <Field orientation="horizontal">
                                <Switch
                                    ...
                                    onCheckedChange={(checked) =>
                                        toggleBoolean('is_now_showing', checked === true)
                                    }
                                />
                                <FieldContent>
                            ...
                            <Field orientation="horizontal">
                                ...
                                <FieldContent>
                                    ...
                                    <FieldDescription>
                                        A simple yes or no field for audience suitability.
                                    </FieldDescription>
                                </FieldContent>
                            </Field>
                        </CardContent>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid gap-4">
                            <Heading
                                ...
                                description={form.data.tagline || 'Add a tagline to make the detail page feel richer.'}
                            />

                            <div className="flex flex-wrap gap-2">
                                <Badge variant="outline">{selectedSummary[0]}</Badge>
                                <Badge variant="outline">{selectedSummary[1]}</Badge>
                                <Badge variant="outline">{selectedSummary[2]}</Badge>
                                {form.data.is_featured && <Badge>Featured</Badge>}
                        ...
                        >
                            <Checkbox
                                ...
                                onCheckedChange={(nextValue) =>
                                    onToggle(field, option.value, nextValue === true)
                                }
                            />
                            <FieldContent>
