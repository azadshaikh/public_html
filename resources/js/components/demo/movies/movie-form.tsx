        ...
        <div className="grid gap-6">
              ...
              <FieldGroup className="md:grid-cols-2">
                <Field data-invalid={Boolean(form.errors.release_date)}>
                  ...
                  <Input
                    ...
                    aria-invalid={
                      Boolean(form.errors.release_date) || undefined
                    }
                  />
                ...
                <Field data-invalid={Boolean(form.errors.release_time)}>
                  ...
                  <Input
                    ...
                    aria-invalid={
                      Boolean(form.errors.release_time) || undefined
                    }
                  />
              ...
              <FieldGroup className="md:grid-cols-3">
                <Field data-invalid={Boolean(form.errors.runtime_minutes)}>
                  ...
                  <Input
                    ...
                    aria-invalid={
                      Boolean(form.errors.runtime_minutes) || undefined
                    }
                    placeholder="124"
                  />
                ...
                <Field data-invalid={Boolean(form.errors.audience_score)}>
                  ...
                  <Input
                    ...
                    aria-invalid={
                      Boolean(form.errors.audience_score) || undefined
                    }
                    placeholder="92"
                  />
              ...
              <FieldGroup className="md:grid-cols-3">
                ...
                <Field data-invalid={Boolean(form.errors.ticket_price)}>
                  ...
                  <Input
                    ...
                    aria-invalid={
                      Boolean(form.errors.ticket_price) || undefined
                    }
                    placeholder="18.50"
                  />
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Use toggles and multi-select fields to test different input
                types.
              </CardDescription>
            </CardHeader>
            <CardContent className="grid gap-6">
              ...
              <FieldGroup>
                <Field data-invalid={Boolean(form.errors.trailer_url)}>
                  ...
                  <InputGroup className="w-full">
                    ...
                    <InputGroupInput
                      ...
                      aria-invalid={
                        Boolean(form.errors.trailer_url) || undefined
                      }
                ...
                <Field data-invalid={Boolean(form.errors.official_site)}>
                  ...
                  <Input
                    ...
                    aria-invalid={
                      Boolean(form.errors.official_site) || undefined
                    }
                    ...
                    <Field orientation="horizontal">
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          toggleBoolean('remove_poster', checked === true)
                        }
                      />
                      <FieldContent>
                  ...
                  {movie?.backdrop_url && (
                    <Field orientation="horizontal">
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          toggleBoolean('remove_backdrop', checked === true)
                        }
                      />
                      <FieldContent>
                        ...
                        <FieldDescription>
                          Lets you test media removal without uploading a
                          replacement.
                        </FieldDescription>
                      </FieldContent>
                    </Field>
            ...
            <CardContent className="grid gap-4">
              ...
              <Field orientation="horizontal">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    toggleBoolean('has_post_credit_scene', checked === true)
                  }
                />
                <FieldContent>
              ...
              <Field orientation="horizontal">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    toggleBoolean('is_family_friendly', checked === true)
                  }
                />
                <FieldContent>
