...
import type { AddressEditTarget, AddressFormValues, AddressTypeOption } from '@/types/address';
...
export default function AddressForm({
    ...
    const form = useAppForm<AddressFormValues>({
        ...
        rememberKey: mode === 'create' ? 'addresses.create' : `addresses.edit.${address?.id ?? 'new'}`,
        dirtyGuard: true,
    });
    ...
    const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
        ...
        form.submit(submitMethod, submitUrl, {
            ...
            successToast: mode === 'create' ? 'Address created.' : 'Address saved.',
        });
    };
                ...
                <Card>
                    ...
                    <CardContent>
                        <FieldGroup>
                            ...
                            <Field data-invalid={form.invalid('company') || undefined}>
                                ...
                                <Input
                                    ...
                                    aria-invalid={form.invalid('company') || undefined}
                                />
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <Field data-invalid={form.invalid('phone_code') || undefined}>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => form.setField('phone_code', e.target.value)}
                            ...
                            <div className="flex flex-col gap-4 pt-2">
                                <Field orientation="horizontal">
                                    <FieldLabel htmlFor="is_primary">Primary address</FieldLabel>
                                    <FieldDescription>Mark as the default address.</FieldDescription>
                                    <Switch
                                        id="is_primary"
                                        checked={form.data.is_primary}
                                        onCheckedChange={(checked) => form.setField('is_primary', checked)}
                                    />
                                </Field>

                                <Field orientation="horizontal">
                                    <FieldLabel htmlFor="is_verified">Verified</FieldLabel>
                                    <FieldDescription>Mark as a verified address.</FieldDescription>
                                    <Switch
                                        id="is_verified"
                                        checked={form.data.is_verified}
                                        onCheckedChange={(checked) => form.setField('is_verified', checked)}
                                    />
                                </Field>
                            </div>
                        </FieldGroup>
                ...
                <Card>
                    ...
                    <CardContent>
                        <FieldGroup>
                            ...
                            <Field data-invalid={form.invalid('address3') || undefined}>
                                <FieldLabel htmlFor="address3">Landmark / address line 3</FieldLabel>
                                <Input
                                    id="address3"
                                    value={form.data.address3}
                                    onChange={(e) => form.setField('address3', e.target.value)}
                                    onBlur={() => form.touch('address3')}
                                    aria-invalid={form.invalid('address3') || undefined}
                                />
                                <FieldError>{form.error('address3')}</FieldError>
                            </Field>
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <Field data-invalid={form.invalid('city') || undefined}>
                                    ...
                                    <CitySelect
                                        ...
                                        value={form.data.city_code || form.data.city}
                                        onChange={(code, name) => {
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <Field data-invalid={form.invalid('latitude') || undefined}>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => form.setField('latitude', e.target.value)}
                                        onBlur={() => form.touch('latitude')}
                                        aria-invalid={form.invalid('latitude') || undefined}
                                    />
                                    <FieldError>{form.error('latitude')}</FieldError>
                                </Field>

                                <Field data-invalid={form.invalid('longitude') || undefined}>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => form.setField('longitude', e.target.value)}
                                        onBlur={() => form.touch('longitude')}
                                        aria-invalid={form.invalid('longitude') || undefined}
                                    />
                                    <FieldError>{form.error('longitude')}</FieldError>
                                </Field>
                            </div>
                        </FieldGroup>
                    </CardContent>
