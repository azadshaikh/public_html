        ...
        <Card className="border-none bg-gradient-to-br from-foreground to-foreground/85 text-background shadow-none ring-0">
          <CardHeader>
            ...
            <CardDescription className="max-w-2xl text-background/75">
              Monitor publishing velocity, editorial pipeline, audience
              engagement, and team activity from one place.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="rounded-xl border bg-muted/40 p-4">
              <div className="mb-1 flex items-center gap-2 text-sm font-medium">
                <CalendarClockIcon className="size-4 text-primary" />6 posts
                scheduled for today
              </div>
              <p className="text-sm text-muted-foreground">
                Confirm hero assets and SEO metadata before the noon publishing
                window.
              </p>
            </div>
            <div className="rounded-xl border bg-muted/40 p-4">
              ...
              <p className="text-sm text-muted-foreground">
                14 content briefs have optimization suggestions for titles,
                excerpts, and CTAs.
              </p>
            </div>
            <div className="rounded-xl border bg-muted/40 p-4">
              ...
              <p className="text-sm text-muted-foreground">
                The API authentication article is trending. Consider featuring
                it on the homepage.
              </p>
            </div>
          </CardContent>
      ...
      <section className="grid gap-4 xl:grid-cols-[1.45fr_0.8fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Latest updates across posts, pages, campaigns, and experiments.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
