...
export default function MoviesDemoIndex({
    ...
    const handleDelete = (movie: MovieListItem) => {
        if (!window.confirm(`Delete ${movie.title}? This will also remove uploaded media.`)) {
            return;
        }
                    ...
                    <Card className="border-none bg-gradient-to-br from-foreground to-foreground/85 text-background shadow-none">
                        <CardHeader>
                            ...
                            <CardDescription className="max-w-2xl text-background/75">
                                A feature-rich demo CRUD for testing text inputs, numeric fields,
                                toggles, grouped checkboxes, filters, and image uploads.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                            <div className="grid gap-3 sm:grid-cols-3">
                                <div>
                                    ...
                                    <div className="text-sm text-background/70">total demo titles</div>
                                </div>
                                <div>
                                    <div className="text-2xl font-semibold">{stats.released}</div>
                                    <div className="text-sm text-background/70">released entries</div>
                                </div>
                                <div>
                                    <div className="text-2xl font-semibold">{stats.average_imdb}</div>
                                    <div className="text-sm text-background/70">average IMDb score</div>
                                </div>
                            </div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Titles marked for spotlight placement.</CardDescription>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Useful for testing badge and filter combinations.</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="text-3xl font-semibold">{stats.now_showing}</div>
                            </CardContent>
                        </Card>
                    </div>
                </section>
                    ...
                    <CardHeader>
                        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                            <div className="flex flex-col gap-1">
                                ...
                                <CardDescription>
                                    Showing {movies.from ?? 0}–{movies.to ?? 0} of {movies.total} demo titles.
                                </CardDescription>
                            </div>
