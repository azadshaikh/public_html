            ...
            <div className="flex flex-col gap-8">
                    ...
                    <Card className="border-none bg-gradient-to-br from-foreground to-foreground/85 text-background shadow-none">
                        <CardHeader>
                            ...
                            <CardDescription className="max-w-2xl text-background/75">
                                A feature-rich demo CRUD for testing text
                                inputs, numeric fields, toggles, grouped
                                checkboxes, filters, and image uploads.
                            </CardDescription>
                        </CardHeader>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Useful for testing badge and filter
                                    combinations.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Search and combine filters to exercise the
                            query-string state.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                    ...
                    <CardHeader>
                        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                            <div className="flex flex-col gap-1">
                                ...
                                <CardDescription>
                                    Showing {movies.from ?? 0}–{movies.to ?? 0}{' '}
                                    of {movies.total} demo titles.
                                </CardDescription>
                            </div>
                            ...
                            <>
                                ...
                                <div className="flex flex-col gap-3 border-t pt-4 sm:flex-row sm:items-center sm:justify-between">
                                    <div className="text-sm text-muted-foreground">
                                        Page {movies.current_page} of{' '}
                                        {movies.last_page}
                                    </div>
                                    <div className="flex gap-2">
                                        <Button
                                            asChild={
                                                movies.prev_page_url !== null
                                            }
                                            variant="outline"
                                            disabled={
                                                movies.prev_page_url === null
