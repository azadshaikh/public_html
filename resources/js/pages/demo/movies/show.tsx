        ...
        <section className="grid gap-6 xl:grid-cols-[minmax(0,1.7fr)_minmax(320px,1fr)]">
          ...
          <Card>
            ...
            <CardContent className="grid gap-4 text-sm">
              ...
              <Fact
                label="Ticket price"
                value={movie.ticket_price_formatted ?? 'Not provided'}
              />
            </CardContent>
          </Card>
        </section>
          ...
          <div className="grid gap-6">
            ...
            <Card>
              ...
              <CardContent className="flex flex-wrap gap-2">
                <Badge
                  variant={movie.is_family_friendly ? 'default' : 'outline'}
                >
                ...
                <Badge
                  variant={movie.has_post_credit_scene ? 'default' : 'outline'}
                >
          ...
          <div className="grid gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Secondary upload field for testing media replacement.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <MovieArtwork
            ...
            {movie.notes && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Optional textarea content for admin-style workflows.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm leading-7 whitespace-pre-line text-muted-foreground">
