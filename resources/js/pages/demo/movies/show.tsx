...
export default function ShowMovieDemo({ movie }: MovieShowPageProps) {
    ...
    const handleDelete = () => {
        if (
            !window.confirm(
                `Delete ${movie.title}? This also removes uploaded poster and backdrop files.`,
            )
        ) {
            return;
        }
    ...
    return (
        <AppLayout
            ...
            description={
                movie.tagline ??
                'Inspect the full movie demo record and media attachments.'
            }
        >
                ...
                <section className="grid gap-6 xl:grid-cols-[minmax(0,1.7fr)_minmax(320px,1fr)]">
                    <Card className="border-none bg-gradient-to-br from-foreground to-foreground/85 text-background shadow-none">
                        <CardHeader className="gap-4">
                            <div className="flex flex-wrap gap-2">
                                <Badge
                                    variant="secondary"
                                    className="bg-background/15 text-background hover:bg-background/15"
                                >
                                    {movie.status_label}
                                </Badge>
                                <Badge
                        ...
                        <CardContent className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                            <div className="grid gap-3 sm:grid-cols-3">
                                <Metric
                                    label="Release"
                                    value={movie.release_date_label ?? 'TBD'}
                                />
                                <Metric
                                    label="Runtime"
                                    value={movie.runtime_label ?? 'TBD'}
                                />
                                <Metric
                                    label="IMDb"
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                High-signal data points from the record.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-4 text-sm">
                            ...
                            <Fact
                                label="Studio"
                                value={movie.studio ?? 'Not provided'}
                            />
                            <Fact
                                label="Language"
                                value={movie.language_label ?? 'Not provided'}
                            />
                            <Fact
                                label="Premiere time"
                                value={movie.release_time ?? 'Not provided'}
                            />
                            <Fact
                                label="Ticket price"
                                value={
                                    movie.ticket_price_formatted ??
                                    'Not provided'
                                }
                            />
                        </CardContent>
                        ...
                        <Card>
                            ...
                            <CardContent className="flex flex-wrap gap-2">
                                ...
                                >
                                    {movie.is_family_friendly
                                        ? 'Family friendly'
                                        : 'General audience unknown'}
                                </Badge>
                                <Badge
                                    variant={
                                        movie.has_post_credit_scene
                                            ? 'default'
                                            : 'outline'
                                    }
                                >
                    ...
                    <div className="grid gap-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Secondary upload field for testing media
                                    replacement.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                        ...
                        {movie.notes && (
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Optional textarea content for
                                        admin-style workflows.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <p className="text-sm leading-7 whitespace-pre-line text-muted-foreground">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Grouped array data rendered as badges.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="grid gap-6">
                                ...
                                <BadgeGroup
                                    ...
                                    values={movie.spoken_languages}
                                />
                                <BadgeGroup
                                    title="Formats"
                                    values={movie.available_formats}
                                />
                                <BadgeGroup
                                    title="Streaming platforms"
                                    values={movie.streaming_platforms}
                                />
                                <BadgeGroup
                                    title="Content warnings"
                                    values={movie.content_warnings}
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Numeric fields and URL metadata.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="grid gap-6 lg:grid-cols-2">
                                <FactBlock
                                    title="Budget"
                                    value={
                                        movie.budget_formatted ?? 'Not provided'
                                    }
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    URL fields for external navigation testing.
                                </CardDescription>
                            </CardHeader>
