      ...
      <div className="flex flex-col gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Narrow the registry by name, email, status, or assigned role.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form
            ...
            >
              ...
              >
                ...
                {roles.map((role) => (
                  <NativeSelectOption key={role.id} value={role.name}>
                    {role.display_name}
                  </NativeSelectOption>
                ))}
              </NativeSelect>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Each account can hold multiple roles while permissions continue to
            ...
            {users.length === 0 ? (
              <Empty>
                <EmptyHeader>
                  ...
                  <EmptyDescription>
                    Adjust the filters or create a matching account first.
                  </EmptyDescription>
                </EmptyHeader>
              </Empty>
            ) : (
                      ...
                      <TableCell>
                        <div className="flex justify-end">
                          <Button asChild variant="outline" size="sm">
                            <Link href={ManagedUserController.edit(user.id)}>
