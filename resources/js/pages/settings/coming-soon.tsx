    ...
    const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
        ...
        form.submit('put', route('app.settings.update', 'coming_soon'), {
            ...
            successToast: {
                ...
                description:
                    'Your coming soon mode settings have been saved successfully.',
            },
        });
    };
                            ...
                            <FieldGroup>
                                <Field>
                                    <div className="flex items-center justify-between gap-4">
                                        <div className="space-y-1">
                                            ...
                                            <FieldDescription>
                                                Display a coming soon page to
                                                visitors while you prepare your
                                                site.
                                            </FieldDescription>
                                        </div>
                                        <Switch
                                ...
                                {form.data.enabled ? (
                                    ...
                                    >
                                        ...
                                        <FieldDescription>
                                            Message displayed on the coming soon
                                            page.
                                        </FieldDescription>
                                        <Textarea
                                            id="description"
