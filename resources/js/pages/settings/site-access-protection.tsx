...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Settings', href: route('app.settings.index') },
    {
        ...
        href: route('app.settings.site-access-protection'),
    },
];
...
export default function SiteAccessProtection({
    settings,
    settingsNav,
    ...
    const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
        ...
        form.submit(
            'put',
            route('app.settings.update', 'site_access_protection'),
            {
                preserveScroll: true,
                ...
                successToast: {
                    ...
                    description:
                        'Your site access protection settings have been saved successfully.',
                },
            },
        );
    };
                            ...
                            <FieldGroup>
                                ...
                                {form.data.mode_enabled ? (
                                    <>
                                        ...
                                        >
                                            <FieldLabel htmlFor="protection_message">
                                                Protection Message
                                            </FieldLabel>
                                            <FieldDescription>
                                                Message displayed to visitors on
                                                the password page.
                                            </FieldDescription>
                                            <Textarea
                                                id="protection_message"
                                                value={
                                                    form.data.protection_message
                                                }
                                                onChange={(e) =>
                                                    form.setField(
                                                        'protection_message',
