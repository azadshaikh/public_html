...
<x-app-layout title="Add Website">
    ...
    <x-page-header title="Add Website"
        description="Add a new website to your platform" layout="form"
        :actions="[
            [
                'label' => 'Back',
    ...
    <form data-dirty-form class="needs-validation" id="website-form" method="POST" action="{{ $formConfig['action'] ?? route('platform.websites.store') }}" novalidate>
        @csrf
