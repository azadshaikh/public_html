{{-- Create Domain Form --}}
<x-app-layout title="Add New Domain">

    {{-- Page Header --}}
    <x-page-header title="Add New Domain"
        description="Register a new domain to manage" layout="form"
        :actions="[
            [
                'label' => 'Back',
    ...
    {{-- Domain Form --}}
    <form data-dirty-form class="needs-validation" id="domain-form" method="POST" action="{{ $formConfig['action'] ?? route('platform.domains.store') }}" novalidate>
        @csrf
