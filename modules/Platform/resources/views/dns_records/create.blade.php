{{-- Create DNS Record Drawer/Offcanvas Content --}}
<div class="offcanvas-header border-bottom">
    <h5 class="offcanvas-title" id="dnsRecordDrawerLabel">Add DNS Record</h5>
    <button class="btn-close" data-bs-dismiss="offcanvas" type="button" aria-label="Close"></button>
</div>

<form data-dirty-form class="d-flex flex-column h-100" id="dns-record-form" action="{{ route('platform.dns.store') }}" method="POST" novalidate>
