...
function buildWebsiteIdExample(prefix: string, zeroPadding: string): string {
                ...
                <div className="flex flex-col gap-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Capture the core account identity and ownership
                                details used across the platform.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <FieldGroup>
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    >
                                        ...
                                        />
                                        <FieldDescription>
                                            Internal account name shown in
                                            operations, billing, and website
                                            assignment flows.
                                        </FieldDescription>
                                        <FieldError>
                                            {form.error('name')}
                                    ...
                                    >
                                        ...
                                        />
                                        <FieldDescription>
                                            Primary contact used for agency
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Set the branding metadata pushed to
                                agency-managed websites and reseller surfaces.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <FieldGroup>
                                ...
                                >
                                    ...
                                    />
                                    <FieldDescription>
                                        Brand label exposed to agency-managed
                                        websites and webhook consumers.
                                    </FieldDescription>
                                    <FieldError>
                                ...
                                >
                                    ...
                                    />
                                    <FieldDescription>
                                        Public website for the agency brand or
                                        reseller storefront.
                                    </FieldDescription>
                                    <FieldError>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Use the structured geo controls so agency
                                contact details stay consistent with the rest of
                                the platform.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                <div className="flex flex-col gap-6 xl:sticky xl:top-6 xl:self-start">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Review the defaults that will shape website IDs,
                                SaaS platform linkage, and webhook routing.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <FieldGroup>
                                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-1">
                                    ...
                                    >
                                        ...
                                        />
                                        <FieldDescription>
                                            Short alphanumeric prefix used for
                                            generated website IDs.
                                        </FieldDescription>
                                        <FieldError>
                                ...
                                {canLinkAgencyWebsite ? (
                                    ...
                                    <div className="rounded-xl border border-dashed border-border/70 bg-muted/20 p-4 text-sm leading-6 text-muted-foreground">
                                        Save the agency first to link its SaaS
                                        platform website and enable the shared
                                        API secret.
                                    </div>
                                )}
                                ...
                                >
                                    ...
                                    <FieldDescription>
                                        ...
                                        events are posted to this endpoint.
                                    </FieldDescription>
                                    <FieldError>
                                        {form.error('webhook_url')}
                                    </FieldError>
                                </Field>
                            </FieldGroup>
                        </CardContent>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Control whether the agency is active for
                                operational use.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <FieldGroup>
                                {mode === 'create' ? (
                                    <div className="rounded-xl border border-border/70 bg-muted/20 p-4 text-sm leading-6 text-muted-foreground">
                                        ...
                                        . You can adjust the status after the
                                ...
                                >
                                    <FieldContent>
                                        ...
                                        <FieldDescription>
                                            Configure branding, webhook URL, and
                                            agency website before onboarding
                                            reseller traffic.
                                        </FieldDescription>
                                    </FieldContent>
