...
export default function SecretForm({
    ...
    const form = useAppForm<SecretFormValues>({
        ...
        rememberKey:
            mode === 'create'
                ...
                : `platform.secrets.edit.${secret?.id ?? 'new'}`,
        dirtyGuard: true,
    });
    ...
    const submitUrl =
        mode === 'create'
            ...
            : route('platform.secrets.update', secret!.id);
                ...
                <div className="flex flex-col gap-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Attach a secret to a specific platform entity
                            ...
                            <FieldGroup>
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    >
                                        ...
                                        <FieldError>
                                            {form.error('secretable_type')}
                                        </FieldError>
                                    </Field>

                                    <Field
                                        data-invalid={
                                            form.invalid('secretable_id') ||
                                            undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="secretable_id">
                                            Entity ID
                                        </FieldLabel>
                                        <Input
                                            id="secretable_id"
                                        ...
                                        />
                                        <FieldDescription>
                                            Enter the numeric ID of the selected
                                            domain, website, agency, server, or
                                            provider.
                                        </FieldDescription>
                                        <FieldError>
                                            {form.error('secretable_id')}
                                        </FieldError>
                                    </Field>
                                </div>
                                ...
                                <Field
                                    data-invalid={
                                        form.invalid('value') || undefined
                                    }
                                >
                                    <FieldLabel htmlFor="value">
                                        {mode === 'create'
                                            ? 'Secret value'
                                            : 'Secret value (leave blank to keep current)'}
                                    </FieldLabel>
                                    <Textarea
                                        id="value"
                        ...
                        <CardContent>
                            <FieldGroup>
                                <Field orientation="horizontal">
                                    ...
                                    <FieldDescription>
                                        Inactive secrets stay stored but should
                                        not be used for automation.
                                    </FieldDescription>
                                    <Switch
                                        id="is_active"
