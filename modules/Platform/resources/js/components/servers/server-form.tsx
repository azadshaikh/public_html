...
export default function ServerForm({
    ...
    const showProvisioning =
        mode === 'create' && form.data.creation_mode === 'provision';
                ...
                <div className="flex flex-col gap-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Configure the Hestia endpoint and access
                            ...
                            <FieldGroup>
                                {mode === 'create' ? (
                                    <Field>
                                        ...
                                        <FieldDescription>
                                            Use manual mode for existing Hestia
                                            servers, or provision mode for fresh
                                            VPS setup.
                                        </FieldDescription>
                                    </Field>
                                ) : null}
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    <Field
                                        data-invalid={
                                            form.invalid('fqdn') || undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="fqdn">
                                            FQDN
                                        </FieldLabel>
                                        <Input
                                            id="fqdn"
                                    ...
                                    <Field
                                        data-invalid={
                                            form.invalid('max_domains') ||
                                            undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="max_domains">
                                            Max domains
                                        </FieldLabel>
                                        <Input
                                            id="max_domains"
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    <Field orientation="horizontal">
                                        <FieldLabel htmlFor="monitor">
                                            Monitoring
                                        </FieldLabel>
                                        <FieldDescription>
                                            Enable health and uptime monitoring.
                                        </FieldDescription>
                                        <Switch
                                            id="monitor"
                                ...
                                {!showProvisioning ? (
                                    <>
                                        <div className="grid gap-4 md:grid-cols-2">
                                            ...
                                            >
                                                <FieldLabel htmlFor="access_key_id">
                                                    Access key ID
                                                </FieldLabel>
                                                <Input
                                                    id="access_key_id"
                                                    value={
                                                        form.data.access_key_id
                                                    }
                                                    onChange={(event) =>
                                                        form.setField(
                                                            'access_key_id',
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Used for provisioning, release synchronization,
                                and diagnostics.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <FieldGroup>
                                <div className="grid gap-4 md:grid-cols-2">
                                    <Field
                                        data-invalid={
                                            form.invalid('ssh_port') ||
                                            undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="ssh_port">
                                            SSH port
                                        </FieldLabel>
                                        <Input
                                            id="ssh_port"
                                    ...
                                    <Field
                                        data-invalid={
                                            form.invalid('ssh_user') ||
                                            undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="ssh_user">
                                            SSH user
                                        </FieldLabel>
                                        <Input
                                            id="ssh_user"
                                ...
                                <Field
                                    data-invalid={
                                        form.invalid('ssh_public_key') ||
                                        undefined
                                    }
                                >
                                    <FieldLabel htmlFor="ssh_public_key">
                                        SSH public key
                                    </FieldLabel>
                                    <Input
                                        id="ssh_public_key"
                                    ...
                                    {sshCommand ? (
                                        <FieldDescription>
                                            Authorize this key on the target
                                            server with: {sshCommand}
                                        </FieldDescription>
                                    ) : null}
                                    <FieldError>
                                        {form.error('ssh_public_key')}
                                    </FieldError>
                                </Field>

                                <Field
                                    data-invalid={
                                        form.invalid('ssh_private_key') ||
                                        undefined
                                    }
                                >
                                    <FieldLabel htmlFor="ssh_private_key">
                                        SSH private key
                                    </FieldLabel>
                                    <Input
                                        id="ssh_private_key"
                                    ...
                                    />
                                    <FieldError>
                                        {form.error('ssh_private_key')}
                                    </FieldError>
                                </Field>

                                <Field
                                    data-invalid={
                                        form.invalid('release_api_key') ||
                                        undefined
                                    }
                                >
                                    <FieldLabel htmlFor="release_api_key">
                                        Release API key
                                    </FieldLabel>
                                    <Input
                                        id="release_api_key"
                    ...
                    {showProvisioning ? (
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Configure how Hestia and related packages
                                    will be installed on a fresh server.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <FieldGroup>
                                    <div className="grid gap-4 md:grid-cols-2">
                                        <Field
                                            data-invalid={
                                                form.invalid('install_port') ||
                                                undefined
                                            }
                                        >
                                            <FieldLabel htmlFor="install_port">
                                                Install port
                                            </FieldLabel>
                                            <Input
                                                id="install_port"
                                            ...
                                            />
                                            <FieldError>
                                                {form.error('install_port')}
                                            </FieldError>
                                        </Field>

                                        <Field
                                            data-invalid={
                                                form.invalid('install_lang') ||
                                                undefined
                                            }
                                        >
                                            <FieldLabel htmlFor="install_lang">
                                                Install language
                                            </FieldLabel>
                                            <Input
                                                id="install_lang"
                                    ...
                                    <Field
                                        data-invalid={
                                            form.invalid(
                                                'install_multiphp_versions',
                                            ) || undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="install_multiphp_versions">
                                            Multi PHP versions
                                        </FieldLabel>
                                        <Input
                                    ...
                                    <Field
                                        data-invalid={
                                            form.invalid('release_zip_url') ||
                                            undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="release_zip_url">
                                            Release ZIP URL
                                        </FieldLabel>
                                        <Input
                                            id="release_zip_url"
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Manual mode expects Hestia to be installed
                                    and reachable over the configured API port.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    Use manual mode for servers that already
                                    have Hestia and API credentials configured.
                                    SSH details remain optional for later
                                    reprovisioning or release operations.
                                </p>
                            </CardContent>
                        </Card>
                    )}
