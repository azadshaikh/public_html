...
export default function SslCertificateForm({
    ...
    const submitUrl =
        mode === 'create'
            ...
            : route('platform.domains.ssl-certificates.update', [
                  domain.id,
                  certificate!.id,
              ]);
                ...
                <div className="flex flex-col gap-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Manage the authority, covered domains, and
                                expiry details for this certificate.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <FieldGroup>
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                <SelectGroup>
                                                    {certificateAuthorityOptions.map(
                                                        (option) => (
                                                            <SelectItem
                                                                key={String(
                                                                    option.value,
                                ...
                                <Field orientation="horizontal">
                                    <FieldLabel htmlFor="is_wildcard">
                                        Wildcard certificate
                                    </FieldLabel>
                                    <FieldDescription>
                                        Mark when the certificate covers
                                        subdomains through a wildcard SAN.
                                    </FieldDescription>
                                    <Switch
                                        id="is_wildcard"
                                        checked={form.data.is_wildcard}
                                ...
                                <Field
                                    data-invalid={
                                        form.invalid('domains') || undefined
                                    }
                                >
                                    <FieldLabel htmlFor="domains">
                                        Covered domains
                                    </FieldLabel>
                                    <Textarea
                                        id="domains"
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    <Field
                                        data-invalid={
                                            form.invalid('issuer') || undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="issuer">
                                            Issuer
                                        </FieldLabel>
                                        <Input
                                            id="issuer"
                                    ...
                                    <Field
                                        data-invalid={
                                            form.invalid('issued_at') ||
                                            undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="issued_at">
                                            Issued on
                                        </FieldLabel>
                                        <Input
                                            id="issued_at"
                ...
                <div className="flex flex-col gap-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Store the private key, certificate, and optional
                                chain bundle in PEM format.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <FieldGroup>
                                <Field
                                    data-invalid={
                                        form.invalid('private_key') || undefined
                                    }
                                >
                                    ...
                                    <Textarea
                                        ...
                                        aria-invalid={
                                            form.invalid('private_key') ||
                                            undefined
                                        }
                                        rows={10}
                                    />
                                    <FieldError>
                                        {form.error('private_key')}
                                    </FieldError>
                                </Field>

                                <Field
                                    data-invalid={
                                        form.invalid('certificate') || undefined
                                    }
                                >
                                    ...
                                    <Textarea
                                        ...
                                        aria-invalid={
                                            form.invalid('certificate') ||
                                            undefined
                                        }
                                        rows={10}
                                    />
                                    <FieldError>
                                        {form.error('certificate')}
                                    </FieldError>
                                </Field>

                                <Field
                                    data-invalid={
                                        form.invalid('ca_bundle') || undefined
                                    }
                                >
                                    <FieldLabel htmlFor="ca_bundle">
                                        CA bundle
                                    </FieldLabel>
                                    <Textarea
                                        id="ca_bundle"
                                        ...
                                        aria-invalid={
                                            form.invalid('ca_bundle') ||
                                            undefined
                                        }
                                        rows={8}
                                    />
                                    <FieldError>
                                        {form.error('ca_bundle')}
                                    </FieldError>
                                </Field>
                            </FieldGroup>
                        </CardContent>
