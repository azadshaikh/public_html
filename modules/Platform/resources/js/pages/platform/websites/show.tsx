            ...
            <div className="flex flex-col gap-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Runtime status, domain routing, and infrastructure
                            placement.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <MetricCard
                            label="Status"
                            value={website.status_label}
                        />
                        <MetricCard label="Type" value={website.type} />
                        <MetricCard label="Plan" value={website.plan} />
                        <MetricCard
                            label="Server"
                            value={website.server_name}
                        />
                        <MetricCard
                            label="Agency"
                            value={website.agency_name}
                        />
                        <MetricCard label="DNS mode" value={website.dns_mode} />
                        <MetricCard
                            label="Astero version"
                            value={website.astero_version}
                        />
                        <MetricCard
                            label="Admin slug"
                            value={website.admin_slug}
                        />
                        <MetricCard
                            label="Media slug"
                            value={website.media_slug}
                        />
                        <MetricCard label="Pull zone" value={pullzoneId} />
                        <MetricCard
                            label="Queue worker"
                            value={website.queue_worker_status}
                        />
                ...
                <div className="grid gap-6 xl:grid-cols-2">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Current step state for initial provisioning and
                                retries.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="flex flex-col gap-3">
                            {provisioningSteps.length === 0 ? (
                                <p className="text-sm text-muted-foreground">
                                    No provisioning steps available.
                                </p>
                            ) : (
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Provisioning shortcuts and routing-specific
                                switches.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-4 md:grid-cols-2">
                            <MetricCard
                                label="Uses www"
                                value={website.is_www ? 'Yes' : 'No'}
                            />
                            <MetricCard
                                label="Agency website"
                                value={website.is_agency ? 'Yes' : 'No'}
                            />
                            <MetricCard
                                label="Skip CDN"
                                value={website.skip_cdn ? 'Yes' : 'No'}
                            />
                            <MetricCard
                                label="Skip DNS"
                                value={website.skip_dns ? 'Yes' : 'No'}
                            />
                            <MetricCard
                                label="Skip SSL"
                                value={website.skip_ssl_issue ? 'Yes' : 'No'}
                            />
                            <MetricCard
                                label="Skip email"
                                value={website.skip_email ? 'Yes' : 'No'}
                            />
                        </CardContent>
                    </Card>
                </div>
                ...
                <div className="grid gap-6 xl:grid-cols-2">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Secret entries currently attached to the website
                                record.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="flex flex-col gap-3">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Latest lifecycle actions executed for this
                                website.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="flex flex-col gap-3">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Most recent normalized payload values collected from
                            the website runtime.
                        </CardDescription>
                    </CardHeader>
