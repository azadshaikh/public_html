            ...
            <div className="flex flex-col gap-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Account classification, vendor metadata, and
                    ...
                    <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <MetricCard
                            label="Vendor"
                            value={provider.vendor_label}
                        />
                        <MetricCard
                            label="Status"
                            value={provider.status_label}
                        />
                        <MetricCard
                            label="Websites"
                            value={provider.websites_count}
                        />
                        <MetricCard
                            label="Domains"
                            value={provider.domains_count}
                        />
                        <MetricCard
                            label="Servers"
                            value={provider.servers_count}
                        />
                        <MetricCard
                            label="Agencies"
                            value={provider.agencies_count}
                        />
                        <MetricCard
                ...
                <div className="grid gap-6 xl:grid-cols-2">
                    <RelationList
                        title="Websites"
                        description="Websites currently routed through this provider."
                        items={websites}
                    />
                    <RelationList
                        title="Domains"
                        description="Domains using this provider as registrar or linked integration."
                        items={domains}
                    />
                    <RelationList
                        title="Servers"
                        description="Servers provisioned or associated with this provider."
                        items={servers}
                    />
                    <RelationList
                        title="Agencies"
                        description="Agencies with DNS or CDN affinity to this provider."
                        items={agencies}
                    />
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Latest provider synchronization and lifecycle
                            events.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="flex flex-col gap-3">
