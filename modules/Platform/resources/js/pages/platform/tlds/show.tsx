                ...
                <div className="flex flex-wrap items-center gap-3">
                    {tld.affiliate_link ? (
                        <Button variant="outline" asChild>
                            <a href={tld.affiliate_link} target="_blank" rel="noreferrer">
            ...
            <div className="flex flex-col gap-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Registration, pricing, and display settings stored for this extension.</CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <MetricCard label="Extension" value={tld.tld} />
                        <MetricCard label="WHOIS server" value={tld.whois_server} />
                        ...
                        <MetricCard label="Primary" value={tld.is_main ? 'Yes' : 'No'} />
                        <MetricCard label="Suggested" value={tld.is_suggested ? 'Yes' : 'No'} />
                        <MetricCard label="Display order" value={tld.tld_order} />
                        <MetricCard label="Affiliate link" value={tld.affiliate_link} />
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Latest changes applied to this TLD configuration.</CardDescription>
                    </CardHeader>
