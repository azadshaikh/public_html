...
export default function GenerateSelfSignedCertificate({
    ...
    const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
        ...
        form.submit(
            'post',
            route(
                'platform.domains.ssl-certificates.generate-self-signed.store',
                domain.id,
            ),
            {
                preserveScroll: true,
                    ...
                    <div className="flex flex-col gap-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Define the certificate identity and included
                                    SAN entries.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <FieldGroup>
                                    <div className="grid gap-4 md:grid-cols-2">
                                        ...
                                        <Field
                                            data-invalid={
                                                form.invalid('key_type') ||
                                                undefined
                                            }
                                        >
                                            <FieldLabel htmlFor="key_type">
                                                Key type
                                            </FieldLabel>
                                            <Input
                                                id="key_type"
                                    ...
                                    <div className="grid gap-4 md:grid-cols-2">
                                        <Field
                                            data-invalid={
                                                form.invalid('common_name') ||
                                                undefined
                                            }
                                        >
                                            <FieldLabel htmlFor="common_name">
                                                Common name
                                            </FieldLabel>
                                            <Input
                                                id="common_name"
                                            ...
                                            />
                                            <FieldError>
                                                {form.error('common_name')}
                                            </FieldError>
                                        </Field>
                                        <Field
                                            data-invalid={
                                                form.invalid('validity_days') ||
                                                undefined
                                            }
                                        >
                                    ...
                                    <Field
                                        data-invalid={
                                            form.invalid('san_domains') ||
                                            undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="san_domains">
                                            SAN domains
                                        </FieldLabel>
                                        <Textarea
                                            id="san_domains"
                                            value={form.data.san_domains}
                                            onChange={(event) =>
                                                form.setField(
                                                    'san_domains',
                                                    event.target.value,
                                        ...
                                        />
                                        <FieldDescription>
                                            Enter one hostname per line to
                                            include in the certificate SAN list.
                                        </FieldDescription>
                                        <FieldError>
                                            {form.error('san_domains')}
                                        </FieldError>
                                    </Field>
                                </FieldGroup>
                            </CardContent>
                    ...
                    <div className="flex flex-col gap-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Optional certificate subject fields used for
                                    issuer generation.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <FieldGroup>
                                    ...
                                    <Field
                                        data-invalid={
                                            form.invalid('org_unit') ||
                                            undefined
                                        }
                                    >
                                        <FieldLabel htmlFor="org_unit">
                                            Organization unit
                                        </FieldLabel>
                                        <Input
                                            id="org_unit"
                                            value={form.data.org_unit}
                                            onChange={(event) =>
                                                form.setField(
                                                    'org_unit',
                                                    event.target.value,
