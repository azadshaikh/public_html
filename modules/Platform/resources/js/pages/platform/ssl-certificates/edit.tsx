...
export default function SslCertificatesEdit(
    props: SslCertificatesEditPageProps,
) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit',
            href: route('platform.domains.ssl-certificates.edit', [
                props.domain.id,
                props.certificate.id,
            ]),
        },
        ...
        >
            <div className="flex flex-col gap-6">
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    <MetricCard
                        label="Authority"
                        value={props.certificateDetails.certificate_authority}
                    />
                    <MetricCard
                        label="Issuer"
                        value={props.certificateDetails.issuer}
                    />
                    <MetricCard
                        label="Expires"
                        value={props.certificateDetails.expires_at}
                    />
                    <MetricCard
                        label="Wildcard"
                        value={
                            props.certificateDetails.is_wildcard ? 'Yes' : 'No'
                        }
                    />
                </div>
                ...
                <SslCertificateForm
                    ...
                    certificateAuthorityOptions={
                        props.certificateAuthorityOptions
                    }
                />
            </div>
        </AppLayout>
