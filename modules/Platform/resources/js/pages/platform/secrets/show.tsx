            ...
            <div className="flex flex-col gap-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Entity assignment, secret type, and activation
                            details.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <MetricCard
                            label="Entity type"
                            value={secret.secretable_type_label}
                        />
                        <MetricCard
                            label="Entity"
                            value={secret.secretable_name}
                        />
                        <MetricCard
                            label="Entity ID"
                            value={secret.secretable_id}
                        />
                        <MetricCard
                            label="Status"
                            value={secret.is_active_label}
                        />
                        <MetricCard
                            label="Expired"
                            value={secret.is_expired ? 'Yes' : 'No'}
                        />
                        <MetricCard
                            label="Expires at"
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Normalized key-value metadata stored alongside the
                            encrypted payload.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                        {Object.keys(secret.metadata).length === 0 ? (
                            ...
                            Object.entries(secret.metadata).map(
                                ([key, value]) => (
                                    <MetricCard
                                        key={key}
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Latest lifecycle events for this secret record.
                        </CardDescription>
                    </CardHeader>
