...
class ServerRequest extends ScaffoldRequest
{
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'server_cpu' => ['nullable', 'string', 'max:255'],
            'server_ccore' => ['nullable', 'integer', 'min:0'],
            'server_ram' => ['nullable', 'integer', 'min:0'],
            'server_storage' => ['nullable', 'integer', 'min:0'],
            'server_os' => ['nullable', 'string', 'max:255'],
            'astero_version' => ['nullable', 'string', 'max:50'],
            'hestia_version' => ['nullable', 'string', 'max:50'],
