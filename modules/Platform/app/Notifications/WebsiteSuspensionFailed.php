...
class WebsiteSuspensionFailed extends PlatformNotification
{
    /**
    ...
    public function toDatabase($notifiable): array
    {
        ...
        return $this->payload('Website Suspension Failed!', $text, 'suspension_failed', 'website', 'high', 'ri-error-warning-fill', $urlBackend, $urlFrontend, 'View website in app', 'Visit website')
            ->extra([
