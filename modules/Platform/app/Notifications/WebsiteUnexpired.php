...
class WebsiteUnexpired extends PlatformNotification
{
    /**
    ...
    public function toDatabase($notifiable): array
    {
        ...
        return $this->payload('Website Unexpired!', $text, 'unexpired', 'website', 'medium', 'ri-history-line', $urlBackend, $urlFrontend, 'View website in app', 'Visit website')
            ->extra([
