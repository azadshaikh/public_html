...
// Bind them into this module scope so references don't throw under ES modules.
const __AOS_ROOT__ = typeof globalThis !== 'undefined' ? globalThis : window;
const Astero = __AOS_ROOT__.Astero;
const SectionInput = __AOS_ROOT__.SectionInput;
const SelectInput = __AOS_ROOT__.SelectInput;
const RangeInput = __AOS_ROOT__.RangeInput;
const ButtonInput = __AOS_ROOT__.ButtonInput;
...
Astero.Components.extend('_base', '_base', ComponentBaseAnimateScroll);
