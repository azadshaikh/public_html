let bgVideoTemplate =
    '<video playsinline loop muted autoplay src="../../media/sample.webm" poster="../../media/sample.webp"><video>';
let bgImageTemplate = '<img src="../../media/4.jpg">';
let defaultSeparatorSvg =
...
//Astero.Components.add("elements/section", {
Astero.Components.extend('_base', 'elements/section', {
    nodes: ['section'],
    name: 'Section',
...
//Astero.Components.add("elements/header", {
Astero.Components.extend('_base', 'elements/header', {
    nodes: ['header'],
    name: 'Header',
    icon: 'ri-layout-row-line',
    html: `<header>
...
//Astero.Components.add("elements/footer", {
Astero.Components.extend('_base', 'elements/footer', {
    nodes: ['footer'],
    name: 'Footer',
    icon: 'ri-layout-row-line',
    html: `<footer>
