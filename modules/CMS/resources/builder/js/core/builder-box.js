...
Object.assign(Astero.Builder, {
        ...
        self.bindAddSectionButton = function (btnId) {
            ...
            addSectionElement?.addEventListener('click', function (event) {
                ...
                if (addSectionModal && typeof bootstrap !== 'undefined') {
                    ...
                    console.error(
                        'Bootstrap Modal is not available or #add-section-modal missing.',
                    );
                }
            ...
            ?.addEventListener('click', async function (event) {
                ...
                if (item) {
                    ...
                    try {
                        ...
                        if (!html) {
                            console.error(
                                'Could not resolve HTML for item:',
                                type,
                            );
                            return;
                        }
                        ...
                        if (!positionTarget) {
                            ...
                            positionTarget =
                                self.frameDoc.body.querySelector(
                                    '[data-astero-enabled]',
                                ) || self.frameDoc.body;
                        }
                        ...
                        if (Astero.TreeList)
                            Astero.TreeList.selectComponent(newElement);
                    } catch (e) {
    ...
    _openCodeEditor: function () {
        ...
        if (self.isCodeEditorReady) {
            ...
            require(['vs/editor/editor.main'], function () {
                self.codeEditor = monaco.editor.create(
    ...
    _initCodeEditorEvents: function () {
        ...
        // Cancel button
        document
            .getElementById('code-editor-cancel')
        ...
        // Close overlay click
        document
            .getElementById('astero-code-editor-overlay')
            ?.addEventListener('click', function () {
                self._closeCodeEditor();
            });
        ...
        // Apply button
        document
            .getElementById('code-editor-apply')
            ?.addEventListener('click', function () {
                let html;
        ...
        // Copy button
        document
            .getElementById('code-editor-copy')
            ?.addEventListener('click', function () {
                let html;
                if (self.isCodeEditorReady && self.codeEditor) {
                    html = self.codeEditor.getValue();
    ...
    _closeCodeEditor: function () {
        document.getElementById('astero-code-editor')?.style &&
            (document.getElementById('astero-code-editor').style.display =
                'none');
        document.getElementById('astero-code-editor-overlay')?.style &&
            (document.getElementById(
                'astero-code-editor-overlay',
            ).style.display = 'none');
    },
});
