...
// Define style_section if not already defined
var style_section = window.style_section || 'style';
window.style_section = style_section;

Astero.ComponentsGroup['Elements'] = [
    /*sections */
    'elements/font-icon',
    'elements/carousel',
    'elements/gallery',
...
Astero.Components.extend('_base', 'elements/figure', {
    ...
    stylesheets: [
        {
            ...
            src: Astero.baseUrl + 'css/figure.css',
	...
	javascripts:[
		{
			'src': Astero.baseUrl + 'css/figure.js',
...
//Icon
Astero.Components.extend('_base', 'elements/font-icon', {
    classes: ['la', 'lab'],
    name: 'Font Icon',
    icon: 'ri-star-line',
    html: `<i class="ri-star-line la-2x"></i>`,
    properties: [
        {
            name: 'Icon',
            key: 'icon',
            ...
            data: {
                url: Astero.baseUrl + '../../resources/{value}.html',
                clickElement: 'li',
                insertElement: 'i',
                elements: 'Loading ...',
                options: [
...
Astero.Components.extend('_base', 'elements/svg-icon', {
    nodes: ['svg'],
    name: 'Svg Icon',
    icon: 'ri-star-line',
...
//Gallery
Astero.Components.add('elements/gallery', {
...
//Tabs
Astero.Components.add('elements/tab', {
...
Astero.Components.add('elements/tabs', {
    attributes: ['data-component-tabs'],
    name: 'Tabs',
    icon: 'ri-menu-line',
    html: `
            ...
            onChange: function (node, value, input, component, event) {
                ...
                if (event.action) {
                    if (event.action == 'add') {
                        ...
                        Astero.Components.render('elements/tabs');
                    }
...
//Accordion
Astero.Components.add('elements/accordion', {
    classes: ['accordion'],
    name: 'Accordeon',
            ...
            onChange: function (node, value, input, component, event) {
                ...
                if (event.action) {
                    if (event.action == 'add') {
                        ...
                        //temporary solution to better update list
                        Astero.Components.render('elements/accordion');
                    }
...
Astero.Components.add('elements/flip-box', {
    classes: ['flip-box'],
    name: 'Flip box',
...
Astero.Components.add('elements/counter', {
    nodes: ['.counter'],
    name: 'Counter',
    icon: 'ri-timer-line',
    html: `<i class="font-icon ri-star-line"></i>`,
    properties: [],
});

Astero.Components.add('elements/testimonial', {
    nodes: ['.counter'],
    name: 'Testimonial',
...
Astero.Components.add('elements/social-icons', {
...
function carouselAfterDrop(node) {
    ...
    if (!body.querySelector('#swiper-js')) {
        ...
        lib.addEventListener('load', function () {
            Astero.Builder.iframe.contentWindow.initSwiper();
        });
    } else {
        Astero.Builder.iframe.contentWindow.initSwiper(true);
    }

    return node;
}

Astero.Components.add('elements/carousel', {
    name: 'Carousel',
            ...
            onChange: function (node, value, input, component, event) {
                ...
                if (event.action) {
                    if (event.action == 'add') {
                        ...
                        //temporary solution to better update list
                        Astero.Components.render('elements/carousel');
                    }
                    if (event.action == 'remove') {
...
//Slider
Astero.Components.add('elements/slider', {
    name: 'Slider',
...
Astero.Components.add('elements/icon-list', {
    nodes: ['.counter'],
    name: 'Icon list',
...
Astero.Components.add('elements/divider', {
    nodes: ['.counter'],
    name: 'Divider',
    icon: 'ri-timer-line',
    html: `<i class="font-icon ri-star-line"></i>`,
...
Astero.Components.add('elements/separator', {
    nodes: ['.counter'],
    name: 'Separator',
    icon: 'ri-separator',
    html: `<i class="font-icon ri-star-line"></i>`,
...
Astero.Components.add('elements/Image box', {
    nodes: ['.counter'],
    name: 'Image Box',
    icon: 'ri-timer-line',
    html: `<i class="font-icon ri-star-line"></i>`,
...
Astero.Components.add('elements/Icon box', {
    nodes: ['.counter'],
    name: 'Image Box',
    icon: 'ri-timer-line',
    html: `<i class="font-icon ri-star-line"></i>`,
...
Astero.Components.add('elements/animated-headline', {
    nodes: ['.counter'],
...
Astero.Components.add('elements/price-table', {
    nodes: ['.counter'],
    name: 'Price table',
...
Astero.Components.add('elements/price-list', {
    nodes: ['.counter'],
    name: 'Price list',
    icon: 'ri-timer-line',
    html: `<i class="font-icon ri-star-line"></i>`,
...
Astero.Components.add('elements/reviews', {
    nodes: ['.counter'],
    name: 'Reviews',
...
Astero.Components.add('elements/code', {
    nodes: ['code'],
    name: 'Code',
...
Astero.Components.add('elements/image-compare', {
    nodes: ['.counter'],
    name: 'Image Compare',
...
Astero.Components.add('elements/rating', {
    nodes: ['.rating'],
    name: 'Rating stars',
    ...
    html: `<div class="rating">
                ...
                <i class="ri-star-line text-warning"></i>
                <i class="ri-star-line text-warning"></i>
                <i class="ri-star-line text-secondary"></i>
            </div>`,
    properties: [],
});
