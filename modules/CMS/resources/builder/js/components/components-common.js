...
//display
Astero.Components.extend('_base', '_base', {
    properties: [
        {
            key: 'display_header',
            inputtype: SectionInput,
        ...
        },
        {
            ...
            afterInit: function (node, inputElement) {
                let selector = Astero.StyleManager.getSelectorForElement(node);
...
Astero.Components.extend('_base', '_base', ComponentBaseTypography);
...
Astero.Components.extend('_base', '_base', ComponentBaseSize);
...
Astero.Components.extend('_base', '_base', ComponentBaseMargin);
...
Astero.Components.extend('_base', '_base', ComponentBasePadding);
...
Astero.Components.extend('_base', '_base', ComponentDeviceVisibility);
