...
Astero.Components.extend('_base', 'html/heading', {
    icon: 'ri-heading',
    name: 'Heading',
...
Astero.Components.extend('_base', 'html/link', {
    nodes: ['a'],
    name: 'Link',
...
Astero.Components.extend('_base', 'html/image', {
    nodes: ['img'],
    name: 'Image',
    html: `<img src="${PLACEHOLDER_IMAGE_URL}" class="img-fluid align-center">`,
    icon: 'ri-image-line',
    ...
    init(node) {
        const value = node?.parentNode?.tagName?.toLowerCase() === 'a';
        const group = document.querySelectorAll('.mb-3[data-group="link"]');
        if (group.length) {
            group.forEach((el) => {
                if (value) {
                    el.style.display = '';
...
Astero.Components.extend('_base', 'html/hr', {
    icon: 'ri-separator',
    nodes: ['hr'],
...
Astero.Components.extend('_base', 'html/label', {
    name: 'Label',
    nodes: ['label'],
...
Astero.Components.extend('_base', 'html/textinput', {
    name: 'Input',
    nodes: ['input'],
...
Astero.Components.extend('_base', 'html/selectinput', {
    nodes: ['select'],
    name: 'Select Input',
    icon: 'ri-list-check',
    ...
    beforeInit: function (node) {
        ...
        node.querySelectorAll('option').forEach((el) => {
            const data = { value: el.value, text: el.text };
            i++;
            properties.push({
                name: 'Option ' + i,
                key: 'option' + i,
...
Astero.Components.extend('_base', 'html/textareainput', {
    nodes: ['textarea'],
    name: 'Text Area',
    icon: 'ri-text',
...
Astero.Components.extend('_base', 'html/radiobutton', {
    name: 'Radio Button',
...
Astero.Components.extend('_base', 'html/checkbox', {
    name: 'Checkbox',
...
/*
Astero.Components.extend("_base", "html/fileinput", {
    name: "Input group",
...
Astero.Components.extend('_base', 'html/video', {
    nodes: ['video'],
    name: 'Video',
...
Astero.Components.extend('_base', 'html/button', {
    nodes: ['button'],
    name: 'Html Button',
    icon: 'ri-square-line',
...
Astero.Components.extend('_base', 'html/paragraph', {
    nodes: ['p'],
    name: 'Paragraph',
    icon: 'ri-paragraph',
...
Astero.Components.extend('_base', 'html/blockquote', {
    nodes: ['blockquote'],
    name: 'Blockquote',
...
Astero.Components.extend('_base', 'html/list', {
    nodes: ['ul', 'ol'],
    name: 'List',
            ...
            onChange: function (node, value, input, component, event) {
                ...
                if (event.action) {
                    if (event.action == 'add') {
                        ...
                        Astero.Components.render('html/list');
                    }
...
Astero.Components.extend('_base', 'html/preformatted', {
    nodes: ['pre'],
    name: 'Preformatted',
    icon: 'ri-paragraph',
...
Astero.Components.extend('_base', 'html/form', {
    nodes: ['form'],
...
Astero.Components.extend('_base', 'html/tablerow', {
    nodes: ['tr'],
    icon: 'ri-table-line',
    name: 'Table Row',
...
Astero.Components.extend('_base', 'html/tablecell', {
    nodes: ['td'],
    icon: 'ri-table-line',
    name: 'Table Cell',
    html: '<td>Cell</td>',
...
Astero.Components.extend('_base', 'html/tableheadercell', {
    nodes: ['th'],
    icon: 'ri-table-line',
...
Astero.Components.extend('_base', 'html/tablebody', {
    nodes: ['tbody'],
    icon: 'ri-table-line',
    name: 'Table Body',
...
Astero.Components.extend('_base', 'html/tablefooter', {
    nodes: ['tfooter'],
    icon: 'ri-table-line',
    name: 'Table Footer',
...
Astero.Components.extend('_base', 'html/tablehead', {
    nodes: ['thead'],
    icon: 'ri-table-line',
    name: 'Table Head',
...
Astero.Components.extend('_base', 'html/table', {
    nodes: ['table'],
    classes: ['table'],
    icon: 'ri-table-line',
    name: 'Table',
...
Astero.Components.extend('_base', 'html/audio', {
    nodes: ['audio'],
...
Astero.Components.extend('_base', 'html/pdf', {
...
Astero.Components.extend('_base', 'html/embed', {
...
Astero.Components.extend('_base', 'html/html', {
    nodes: ['html'],
    name: 'Html Page',
...
Astero.Components.extend('_base', 'html/iframe', {
    attributes: ['data-component-iframe'],
    name: 'Iframe',
    icon: 'ri-file-line',
    html: '<div data-component-iframe><iframe src="https://www.astero.com" width="320" height="240"></iframe></div>',
    properties: [
        {
            name: 'Src',
            key: 'src',
