  ...
  <div class="container">
    <div class="row align-items-center w-100">
      ...
      <div class="col-md-6 col-sm-12 col-img">
        <img class="img-fluid" loading="lazy" src="${Astero.builderAssetsUrl}/images/illustrations.co/126-namaste-no-hand-shake.svg" alt="namaste">
      </div>
    </div>
  </div>
</section>`,
...
Astero.Sections.add('showcase/showcase-2', {
  ...
  <div class="container">
    <div class="row align-items-center w-100">
      <div class="col-md-6 col-sm-12 col-img">
        <img class="img-fluid" src="${Astero.builderAssetsUrl}/images/illustrations.co/107-healthy.svg" alt="healthy">
      </div>
      <div class="col-md-6 col-sm-12">
        <h3>Drag and drop builder</h3>
        <p class="lead">Unlimited design powers with an easy to use interface, change anything on your website with a few clicks.</p>
    ...
    <div class="row g-1 justify-content-center">
      <div class="col-12 col-sm-6 col-md-6 col-lg-3">
        <div class="feature" data-aos="fade-up" data-aos-delay="100">
          ...
          <p class="text-center">Astero is 100% safe against sql injections, a vulerability that affects most CMS.</p>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-md-6 col-lg-3">
        <div class="feature" data-aos="fade-up" data-aos-delay="200">
          ...
          <p class="text-center">Astero uses only html for templating for maximum flexibility.</p>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-md-6 col-lg-3">
        <div class="feature" data-aos="fade-up" data-aos-delay="300">
          ...
          <p class="text-center">Astero is a full featured ecommerce platform with advanced functionality.</p>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-md-6 col-lg-3">
    ...
    <div class="row g-1 justify-content-center">
      <div class="col-12 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="0">
        <div class="feature">
          ...
          <p>Astero is 100% safe against sql injections, a vulerability that affects most CMS.</p>
      ...
      <div class="col-12 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
        <div class="feature">
          ...
          <p>Astero uses only html for templating for maximum flexibility.</p>
          <a class="more d-block" href="#">
            Read more
            <i class="font-icon la la-chevron-circle-right"></i>
          </a>
      ...
      <div class="col-12 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
        <div class="feature">
          ...
          <p>Astero is a full featured ecommerce platform with advanced functionality.</p>
          <a class="more d-block" href="#">
            Read more
            <i class="font-icon la la-chevron-circle-right"></i>
          </a>
      ...
      <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
        <div class="feature">
          ...
          <div class="text">
            ...
            <p>Astero is a full featured ecommerce platform with advanced functionality and internationalization.</p>
            <a class="more d-block" href="#">
              Read more
              <i class="font-icon la la-chevron-circle-right"></i>
            </a>
