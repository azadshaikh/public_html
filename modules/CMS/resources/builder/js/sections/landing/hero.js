Astero.Sections.add('hero/hero-1', {
  ...
  <div class="container">
    <div class="heading">
      ...
      <div class="btns">
        <a class="btn btn-primary btn-shadow" href="#" role="button">
          <span>&#9889;</span>
        ...
        <div class="nav-item dropdown">
          <a class="btn btn-outline-primary nav-link dropdown-toggle" href="#" role="button">Live demo <b>›</b>
          </a>
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            <a class="dropdown-item" target="_blank" href="#">Page builder</a>
            <a class="dropdown-item" target="_blank" href="#">Frontend</a>
            <a class="dropdown-item" target="_blank" href="#">Admin dashboard</a>
          </div>
        </div>
      </div>
    ...
    <div class="frame mx-auto">
      <video loading="lazy" muted loop controls poster="${Astero.builderAssetsUrl}/images/demo/video-1.jpg"></video>
    </div>
  </div>
  ...
  <div class="background-container">
    <img src="${Astero.builderAssetsUrl}/images/background.svg" alt="Hero background" loading="lazy">
  </div>
...
Astero.Sections.add('hero/hero-2', {
    ...
    <div class="row align-items-center justify-content-between">
      ...
      <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
        <a href="#" class="video-wrap glightbox">
          ...
          <img src="${Astero.builderAssetsUrl}/images/demo/video-1.jpg" loading="lazy" alt="Video image" class="img-fluid">
        </a>
      </div>
    </div>
  </div>
  ...
  <div class="background-container">
    <img src="${Astero.builderAssetsUrl}/images/demo/hero-3.jpg" alt="Hero background">
  </div>
  ...
  <div class="container">
    <div class="row align-items-center justify-content-center text-center">
      <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
        ...
        <img width="350" src="${Astero.builderAssetsUrl}/images/demo/video-1.jpg" class="shadow img-thumbnail">
    ...
    <div class="row align-items-center d-flex justify-content-between">
      ...
      <div class="col-12 col-md-6 order-sm-1 order-md-2  ">
        <div class="icon-wrap text-primary d-flex justify-content-md-center my-3">
          <a href="#" class="icon d-flex border-0 align-items-center justify-content-center bg-white text-dark shadow-lg rounded-circle" role="button" style="width:70px; height:70px">
...
Astero.Sections.add('hero/hero-6', {
  ...
  <div class="container">
    <div>
      <div class="row align-items-center justify-content-center text-start">
        ...
        <div class="col-lg-5">
          <img src="${Astero.builderAssetsUrl}/images/demo/video-1.jpg" class="shadow img-thumbnail" loading="lazy">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="background-container">
    <img src="${Astero.builderAssetsUrl}/images/demo/hero-3.jpg" alt="Hero background" loading="lazy">
  </div>
</header>`,
});
  ...
  <div class="container">
    <div>
      <div class="row align-items-center justify-content-center text-start g-5">
        <div class="col-lg-5">
          <img src="${Astero.builderAssetsUrl}/images/demo/video-1.jpg" class="shadow img-thumbnail">
        </div>
...
Astero.Sections.add('hero/hero-slider', {
  ...
  <div class="swiper" data-slides-per-view="1" data-draggable="true">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        <img src="${Astero.builderAssetsUrl}/images/demo/hero-3.jpg" loading="lazy">
        <div class="content">
          <div class="container">
            <div>
              <div class="row align-items-center justify-content-center text-start">
  ...
  <link id="swiper-css" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" rel="stylesheet">
  <script>
var swiper = [];
