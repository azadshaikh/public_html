    ...
    <div class="row">
      <div class="col-md-4">
        <div class="price-col shadow">
          <div class="img">
            <img src="${Astero.builderAssetsUrl}/images/illustrations.co/104-dumbbell.svg" alt="104-dumbbell" loading="lazy" class="img-fluid" />
          </div>
      ...
      <div class="col-md-4">
        <div class="price-col shadow">
          <div class="img">
            <img src="${Astero.builderAssetsUrl}/images/illustrations.co/107-healthy.svg" alt="107-healthy" loading="lazy" class="img-fluid" />
          </div>
          <div class="text-center p-4">
      ...
      <div class="col-md-4">
        <div class="price-col shadow">
          <div class="img">
            <img src="${Astero.builderAssetsUrl}/images/illustrations.co/126-namaste-no-hand-shake.svg" alt="126-namaste-no-hand-shake" loading="lazy" class="img-fluid" />
          </div>
          <div class="text-center p-4">
...
Astero.SectionsGroup['Pricing table'] = ['pricing-table/pricing-table-3'];
