  ...
  <div class="container">
    <div class="row my-5">
      ...
      <div class="col-12 col-md-6 ms-auto" data-v-component-plugin-contact-form-form data-v-storage="database" data-v-name="contact-us-home">
        ...
        <form action="" method="post" data-v-astero-action="submit" data-selector="[data-v-component-plugin-contact-form-form]" data-v-astero-on="submit">
  ...
  <div class="">
    <div class="container">
      ...
      <div class="row justify-content-center text-center">
        ...
        <div class="col-12 col-md pt-4 me-auto ms-auto">
          <p class="lead">support@astero.com</p>
        </div>
      </div>
      <div class="row-50"></div>
    </div>
...
Astero.SectionsGroup['Contact form'] = [
