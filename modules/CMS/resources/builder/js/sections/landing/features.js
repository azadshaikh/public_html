Astero.Sections.add('features/features-1', {
  ...
  <div class="container">
    <div class="row wrap">
      ...
      <div class="col-md-5">
        <img src="${Astero.builderAssetsUrl}/images/illustrations.co/118-macbook.svg" alt="Macbook" loading="lazy" class="img-fluid" />
      </div>
    </div>
    <div class="row wrap">
      <div class="col-md-5">
        <img src="${Astero.builderAssetsUrl}/images/illustrations.co/day95-app-development.svg" alt="App development" loading="lazy" class="img-fluid" />
      </div>
      <div class="col-md-7 align-self-center">
...
Astero.Sections.add('features/features-2', {
  ...
  <div class="row no-gutters">
    <div class="col-lg-6">
      <img src="${Astero.builderAssetsUrl}/images/illustrations.co/day68-happy-cat.svg" alt="happy cat" loading="lazy" class="img-fluid">
    </div>
...
Astero.Sections.add('features/features-3', {
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <img src="${Astero.builderAssetsUrl}/images/illustrations.co/day67-dog.svg" alt="dog" loading="lazy" class="img-fluid" />
      </div>
  ...
  <div class="container">
    ...
    <div class="row text-center justify-content-center">
      <div class="col-12 col-sm-4 col-xl-3 m-md-auto">
        <div>
          <img loading="lazy" src="${Astero.builderAssetsUrl}/images/illustrations.co/109-map-location.svg" alt="map location">
          <h3>Drag and drop</h3>
      ...
      <div class="col-12 col-sm-4 col-xl-3 m-md-auto">
        <div>
          <img loading="lazy" src="${Astero.builderAssetsUrl}/images/illustrations.co/107-healthy.svg" alt="dumbbell">
      ...
      <div class="col-12 col-sm-4 col-xl-3 m-md-auto">
        <div>
          <img loading="lazy" src="${Astero.builderAssetsUrl}/images/illustrations.co/104-dumbbell.svg" alt="dumbbell">
          <h3>Bootstrap 5</h3>
  ...
  <div class="container">
    ...
    <div class="row text-center justify-content-center">
      <div class="col-12 col-md-6 col-lg-3">
        <div>
          <img alt="map location" loading="lazy" src="${Astero.builderAssetsUrl}/images/illustrations.co/109-map-location.svg">
          <h3>Drag and drop</h3>
          <p class="lead text-muted mt-4">Intuitive building with simple drag and drop for sections, components and blocks/snippets</p>
      ...
      <div class="col-12 col-md-6 col-lg-3">
        <div>
          <img alt="healthy" loading="lazy" src="${Astero.builderAssetsUrl}/images/illustrations.co/107-healthy.svg">
          <h3>Live code editor</h3>
          <p class="lead text-muted mt-4">Code editor with syntax highglighting that updates in real time</p>
      ...
      <div class="col-12 col-md-6 col-lg-3">
        <div>
          <img alt="dumbbell" loading="lazy" src="${Astero.builderAssetsUrl}/images/illustrations.co/104-dumbbell.svg">
          <h3>Bootstrap 5</h3>
      ...
      <div class="col-12 col-md-6 col-lg-3">
        <div>
          <img alt="namaste" loading="lazy" src="${Astero.builderAssetsUrl}/images/illustrations.co/126-namaste-no-hand-shake.svg">
          <h3>Google fonts</h3>
    ...
    <div class="row text-end align-items-center">
      ...
      <div class="col-12 col-md-7 col-lg-5 m-auto text-start pt-5">
        <div class="row pb-lg-5">
          <div class="col-3">
            <img src="${Astero.builderAssetsUrl}/images/illustrations.co/107-healthy.svg" alt="healthy" loading="lazy" class="img-fluid">
          </div>
          <div class="col-9">
            <h3>
              <strong>Drag and drop</strong>
        ...
        <div class="row pt-4 pt-md-5 pb-lg-5">
          <div class="col-3">
            <img src="${Astero.builderAssetsUrl}/images/illustrations.co/104-dumbbell.svg" alt="dumbbell" loading="lazy" class="img-fluid">
          </div>
          <div class="col-9">
            <h3>
        ...
        <div class="row pt-4 pt-md-5">
          <div class="col-3">
            <img src="${Astero.builderAssetsUrl}/images/illustrations.co/109-map-location.svg" alt="map location" loading="lazy" class="img-fluid">
          </div>
          <div class="col-9">
            <h3>
