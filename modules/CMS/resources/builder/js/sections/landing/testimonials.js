    ...
    <div class="row text-center">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded testimonial">
          ...
          <img src="${Astero.builderAssetsUrl}/images/sections/team/1.jpg" alt="team" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow" loading="lazy">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded testimonial">
          ...
          <p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu sem tempor, varius quam at, luctus dui.</p>
          <img src="${Astero.builderAssetsUrl}/images/sections/team/2.jpg" alt="team" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow" loading="lazy">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded testimonial">
          ...
          <img src="${Astero.builderAssetsUrl}/images/sections/team/3.jpg" alt="team" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow" loading="lazy">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded testimonial">
          ...
          <img src="${Astero.builderAssetsUrl}/images/sections/team/4.jpg" alt="team" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow" loading="lazy">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/1.jpg" class="img-fluid p-4 rounded-circle" loading="lazy">
          </div>
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/2.jpg" class="img-fluid p-4 rounded-circle" loading="lazy">
          </div>
          <div class="col-md-12 text-center">
            <div class="pt-2">
              <h5 class="mt-4 mb-0">John Doe</h5>
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/3.jpg" class="img-fluid p-4 rounded-circle" loading="lazy">
          </div>
          <div class="col-md-12 text-center">
            <div class="pt-2">
              <h5 class="mt-4 mb-0">John Doe</h5>
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/4.jpg" class="img-fluid p-4 rounded-circle" loading="lazy">
          </div>
          <div class="col-md-12 text-center">
            <div class="pt-2">
              <h5 class="mt-4 mb-0">John Doe</h5>
...
Astero.SectionsGroup['Testimonials'] = [
