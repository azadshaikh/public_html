    ...
    <div class="container">
      <div data-v-component-site>
        <a class="navbar-brand" href="/" data-v-url-params='{"host":"www.*.*"}'>
          ...
          <img src="${Astero.builderAssetsUrl}/images/logo.png" alt="Site logo sticky" loading="lazy" class="logo-sticky" data-v-site-logo-sticky>
          ...
          <img src="${Astero.builderAssetsUrl}/images/logo-white.png" alt="Site logo dark sticky" loading="lazy" class="logo-default-dark-sticky" data-v-site-logo-dark-sticky>
        </a>
      </div>
          ...
          <li class="nav-item dropdown position-static" data-v-menu-item data-v-class-if-has-dropdown="category.children > 0" data-v-class-if-position-static="category.has-text">
            ...
            <a class="nav-link dropdown-toggle" href="#" data-v-class-if-dropdown-toggle="category.children > 0" data-v-class-if-active="category.active" aria-expanded="false" data-v-menu-item-url>
              ...
              <span data-v-menu-item-content>
                <p>
                  <img src="/media/astero.svg" height="24" alt="" class="me-2">Mega menu
                </p>
              </span>
            </a>
                  ...
                  <span data-v-if="category.content" data-v-menu-item-content>
                    <div class="row">
                      <div class="col-6 align-self-center">
                        <img src="${Astero.builderAssetsUrl}/images/demo/video-1.jpg" alt="Post" width="250" loading="lazy" class="rounded img-fluid">
                      </div>
                      <div class="col-6">
                        <h4>Features</h4>
          ...
          <li class="nav-toggle">
            ...
            <div class="dropdown user-box nav-item">
              <a class="dropdown-toggle nav-link " href role="button" id="user-dropdown" data-bs-toggle="dropdown" aria-expanded="false" data-v-url="user/index">
                <!-- <img src="${Astero.builderAssetsUrl}/images/user.svg" loading="lazy" width="20" alt> -->
              ...
              <div class="dropdown-menu dropdown-menu-end login-box p-4" aria-labelledby="user-dropdown">
                ...
                <div data-v-component-user>
                  ...
                  <form action method="post" enctype="multipart/form-data" data-v-url="user/login" data-v-astero-action="login" data-v-astero-on="submit" class="login-form">
          ...
          <li class="nav-toggle">
            ...
            <div class="dropdown nav-item mini-cart" data-v-component-cart>
              ...
              <a class="dropdown-toggle cart-info nav-link " href role="button" id="cart-dropdown" data-bs-toggle="dropdown" aria-expanded="false" data-v-url="cart/cart/index">
                <!-- <img src="${Astero.builderAssetsUrl}/images/bag.svg" width="20" alt> -->
                        ...
                        <tr data-v-cart-product>
                          <td class="text-center">
                            <a href="#40" data-v-cart-product-url>
                              <img src="${Astero.builderAssetsUrl}/images/demo/product.jpg" alt="Product name" class="img-rounded" loading="lazy" data-v-cart-product-image width=50>
                            </a>
                          </td>
                          <td class="text-start">
                          ...
                          <td class="text-end">
                            <a class="btn btn-outline-secondary btn-sm border-0" data-v-astero-action="removeFromCart" data-v-cart-product-remove-url>
                              <i class="la la-times"></i>
                            </a>
                          </td>
                        </tr>
	...
	<div class="search-area toggle-hover">
		<form action="/search" method="get" data-v-action="/search">
			...
			<div class="input-group">
				<input type="search" name="search" class="form-control" id="headerSearch" placeholder="Type for search" data-v-astero-action="search" data-v-astero-on="keyup">
			  ...
			  <div class="collapse navbar-collapse" id="navbar">
				<ul class="navbar-nav ms-auto">
				  ...
				  <li class="nav-item active">
					<a class="nav-link" href="#">Download for free</a>
				  </li>
				</ul>
			  </div>
			  -->
...
Astero.SectionsGroup['Navigation'] = [
