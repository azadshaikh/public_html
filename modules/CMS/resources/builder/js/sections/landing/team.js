  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row">
          <div class="col-md-12">
            <img alt="image" loading="lazy" src="${Astero.builderAssetsUrl}/images/sections/team/1.jpg" class="img-fluid p-4 rounded-circle">
          </div>
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row">
          <div class="col-md-12">
            <img alt="image" loading="lazy" src="${Astero.builderAssetsUrl}/images/sections/team/2.jpg" class="img-fluid p-4 rounded-circle">
          </div>
          <div class="col-md-12 text-center">
            <div class="pt-2">
              <h4 class="mt-4 mb-0">John Doe</h4>
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row">
          <div class="col-md-12">
            <img alt="image" loading="lazy" src="${Astero.builderAssetsUrl}/images/sections/team/3.jpg" class="img-fluid p-4 rounded-circle">
          </div>
          <div class="col-md-12 text-center">
            <div class="pt-2">
              <h4 class="mt-4 mb-0">John Doe</h4>
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row">
          <div class="col-md-12">
            <img alt="image" loading="lazy" src="${Astero.builderAssetsUrl}/images/sections/team/4.jpg" class="img-fluid p-4 rounded-circle">
          </div>
          <div class="col-md-12 text-center">
            <div class="pt-2">
              <h4 class="mt-4 mb-0">John Doe</h4>
    ...
    <div class="row justify-content-center py-5">
      <div class="card col-md-3">
        <div class="card-content">
          <div class="card-body p-0">
            <div class="profile">
              <img src="${Astero.builderAssetsUrl}/images/sections/team/1.jpg" loading="lazy" alt="team">
            </div>
      ...
      <div class="card col-md-3">
        <div class="card-content">
          <div class="card-body p-0">
            <div class="profile">
              <img src="${Astero.builderAssetsUrl}/images/sections/team/2.jpg" loading="lazy" alt="team">
            </div>
            <div class="card-title mt-4">
              <h4>John Doe</h4>
      ...
      <div class="card col-md-3">
        <div class="card-content">
          <div class="card-body p-0">
            <div class="profile">
              <img src="${Astero.builderAssetsUrl}/images/sections/team/3.jpg" loading="lazy" alt="team">
            </div>
            <div class="card-title mt-4">
              <h4>Jane Doe</h4>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row no-gutters">
          <div class="col-md-12 pro-pic">
            <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/1.jpg" class="img-fluid p-4" loading="lazy">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row no-gutters">
          <div class="col-md-12 pro-pic">
            <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/2.jpg" class="img-fluid p-4" loading="lazy">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row no-gutters">
          <div class="col-md-12 pro-pic">
            <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/3.jpg" class="img-fluid p-4" loading="lazy">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row no-gutters">
          <div class="col-md-12 pro-pic">
            <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/4.jpg" class="img-fluid p-4" loading="lazy">
...
Astero.Sections.add('team/team-5', {
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="card border-1 mb-4 p-0">

          <div class="row no-gutters">
            <div class="col-md-5">

              <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/1.jpg" class="img-fluid" loading="lazy">
        ...
        <div class="card border-1 mb-4 p-0">
          ...
          <div class="row no-gutters">
            <div class="col-md-5">
              ...
              <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/2.jpg" class="img-fluid" loading="lazy">
        ...
        <div class="card border-1 mb-4 p-0">
          ...
          <div class="row no-gutters">
            <div class="col-md-5">
              ...
              <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/3.jpg" class="img-fluid" loading="lazy">
            </div>
            <div class="col-md-7">
              <div class="p-4">
                <h4 class="mb-3">John Doe</h4>
        ...
        <div class="card border-1 mb-4 p-0">
          <div class="row no-gutters">
            <div class="col-md-5">
              ...
              <img alt="image" src="${Astero.builderAssetsUrl}/images/sections/team/4.jpg" class="img-fluid" loading="lazy">
    ...
    <div class="row text-center">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="bg-white rounded shadow-sm py-5 px-4">
          ...
          <img src="${Astero.builderAssetsUrl}/images/sections/team/1.jpg" alt="team" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" loading="lazy">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="bg-white rounded shadow-sm py-5 px-4">
          ...
          <img src="${Astero.builderAssetsUrl}/images/sections/team/2.jpg" alt="team" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" loading="lazy">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="bg-white rounded shadow-sm py-5 px-4">
          ...
          <img src="${Astero.builderAssetsUrl}/images/sections/team/3.jpg" alt="team" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" loading="lazy">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="bg-white rounded shadow-sm py-5 px-4">
          ...
          <img src="${Astero.builderAssetsUrl}/images/sections/team/4.jpg" alt="team" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" loading="lazy">
