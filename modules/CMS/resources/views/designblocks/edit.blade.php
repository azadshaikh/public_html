<x-app-layout title="Edit Design Block">
    {{-- Page Header --}}
    <x-page-header title="Edit Design Block"
        description="Update design block component"
        layout="form"
                :breadcrumbs="[
            ['label' => 'Dashboard', 'href' => route('dashboard')],
                        ['label' => 'CMS'],
            ['label' => 'Design Blocks', 'href' => route('cms.designblock.index')],
            ['label' => '#' . $designBlock->id],
    ...
    {{-- Form --}}
    <form data-dirty-form class="needs-validation" action="{{ route('cms.designblock.update', $designBlock->id) }}" method="POST" id="design-block-form" novalidate>
        @csrf
        @method('PUT')
