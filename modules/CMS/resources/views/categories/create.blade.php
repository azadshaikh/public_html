<x-app-layout title="Create Category">
    ...
    <x-page-header title="Create Category"
        description="Add a new category for organizing content"
        layout="form"
        :breadcrumbs="[
    ...
    <form data-dirty-form class="needs-validation" action="{{ route('cms.categories.store') }}" method="POST" id="category-form" novalidate>
        @csrf
