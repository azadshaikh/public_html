<x-app-layout title="Create Page">
    {{-- Page Header --}}
    <x-page-header title="Create Page"
        description="Add a new page for your content"
        layout="form"
        :breadcrumbs="[
    ...
    <form data-dirty-form class="needs-validation" action="{{ route('cms.pages.store') }}" method="POST" id="page-form" novalidate>
        @csrf
