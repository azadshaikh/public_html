    ...
    >
      ...
      <section className="grid gap-4 xl:grid-cols-[1.35fr_1fr]">
          ...
          <CardHeader className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <CardDescription className="max-w-2xl text-primary-foreground/75">
                Use this sample CRUD as the foundation for page builders,
                knowledge bases, landing pages, or internal documentation flows.
              </CardDescription>
            </div>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              A tiny but real CRUD that is easy to extend with revisions,
              blocks, SEO fields, or publishing workflows.
            </CardDescription>
          </CardHeader>
      ...
      <Card className="mt-6">
        <CardHeader>
          ...
          <CardDescription>
            Keep the list focused while you shape content models for the module.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form
            ...
            <CardContent className="p-6">
              <Empty>
                <EmptyHeader>
                  ...
                  <EmptyDescription>
                    Create your first CMS record to test content authoring and
                    publishing flows.
                  </EmptyDescription>
                </EmptyHeader>
                <EmptyContent>
