        ...
        >
            <section className="grid gap-4 xl:grid-cols-[1.35fr_1fr]">
                    ...
                    <CardHeader className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <CardTitle className="text-3xl font-semibold tracking-tight md:text-4xl">
                                Build content workflows from a clean page
                                resource.
                            </CardTitle>
                            <CardDescription className="max-w-2xl text-primary-foreground/75">
                                Use this sample CRUD as the foundation for page
                                builders, knowledge bases, landing pages, or
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            A tiny but real CRUD that is easy to extend with
                            revisions, blocks, SEO fields, or publishing
                            workflows.
                        </CardDescription>
                    </CardHeader>
            ...
            <Card className="mt-6">
                <CardHeader>
                    ...
                    <CardDescription>
                        Keep the list focused while you shape content models for
                        the module.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <CardContent className="p-6">
                            <Empty>
                                <EmptyHeader>
                                    ...
                                    <EmptyDescription>
                                        Create your first CMS record to test
                                        content authoring and publishing flows.
                                    </EmptyDescription>
                                </EmptyHeader>
                                <EmptyContent>
                                    <Button asChild>
            ...
            {pages.prev_page_url || pages.next_page_url ? (
                <div className="mt-6 flex items-center justify-between gap-4 text-sm text-muted-foreground">
                    ...
                    <div className="flex gap-2">
                        ...
                        >
                            <Link href={pages.prev_page_url ?? cmsIndexUrl}>
                                Previous
                            </Link>
                        </Button>
                        <Button
                        ...
                        >
                            <Link href={pages.next_page_url ?? cmsIndexUrl}>
                                Next
                            </Link>
                        </Button>
                    </div>
