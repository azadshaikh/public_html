...
export default function ReleaseShow({ release, type, statusOptions }: any) {
    ...
    const currentStatusLabel =
        statusOptions?.find((o: any) => o.value === release.status)?.label ||
        release.status ||
        'Draft';
    ...
    const getBadgeVariant = (val: string) => {
        ...
        if (['deprecate', 'failed', 'danger', 'trash'].includes(val))
            return 'destructive';
                ...
                <div className="flex flex-col gap-6 lg:col-span-2">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <Badge variant={getBadgeVariant(release.status)}>
                                {currentStatusLabel}
                            </Badge>
                        </CardHeader>
                        <CardContent className="grid gap-4 pt-4">
                            ...
                            <div className="grid grid-cols-1 gap-4 border-b pb-4 md:grid-cols-3">
                                ...
                                <div className="font-mono text-xs break-all md:col-span-2">
                                    {release.checksum || '—'}
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                ...
                                <div className="text-sm whitespace-pre-wrap md:col-span-2">
                                    {release.change_log || '—'}
                                </div>
                            </div>
                        </CardContent>
