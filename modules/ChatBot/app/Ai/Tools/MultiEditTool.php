...
DESC;
    ...
    public function handle(Request $request): Stringable|string
    {
        ...
        return $this->executeWithLogging(
            arguments: ['filePath' => $filePath, 'edits' => $edits],
            operation: function () use ($filePath, $edits): string {
                if ($filePath === '') {
                ...
                return app(FileToolService::class)->multiedit(
                    path: $filePath,
                    edits: $edits,
                );
            },
            errorPrefix: 'Error performing multiedit',
        );
    }
