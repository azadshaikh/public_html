    ...
    'sections' => [
        'chatbot' => [
            ...
            'items' => [
                'chatbot_workspace' => [
                    'label' => 'Workspace',
                    'route' => 'app.chatbot.index',
                    'icon' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8V4H8"></path><rect x="4" y="4" width="16" height="16" rx="2"></rect><path d="M8 12h8"></path><path d="M8 16h5"></path></svg>',
                    'permission' => 'use_chatbot',
                    'active_patterns' => ['app.chatbot.index', 'app.chatbot.new', 'app.chatbot.show'],
                ],
                'chatbot_settings' => [
                    'label' => 'Settings',
                    'route' => ['name' => 'app.chatbot.settings.index', 'params' => ['section' => 'general']],
