...
export default function ChatBotCreate({ module, prompt, initialValues, options }: ChatBotCreatePageProps) {
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs} title={`Create ${module.name} prompt`} description={module.description}>
      <Head title={`Create ${module.name} prompt`} />
      <PromptTemplateForm mode="create" module={module} prompt={prompt} initialValues={initialValues} options={options} />
    </AppLayout>
  )
}
