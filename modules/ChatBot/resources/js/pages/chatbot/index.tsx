    ...
    >
      ...
      <section className="grid gap-4 xl:grid-cols-[1.35fr_1fr]">
        <Card className="border-none bg-gradient-to-br from-primary to-primary/80 text-primary-foreground shadow-none ring-0">
          <CardHeader>
            ...
            <CardTitle className="mt-4 text-3xl font-semibold tracking-tight md:text-4xl">
              A chatbot module mounted through the module runtime.
            </CardTitle>
            <CardDescription className="text-primary-foreground/75">
              Use this page to verify a second module can ship its own route, config, and Inertia page.
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-4 sm:grid-cols-3">
            ...
            <div>
              <div className="text-sm text-primary-foreground/70">Module type</div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Standalone AI assistant tooling bundled as a module.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="rounded-xl border bg-muted/40 p-4">
              ...
              <p className="text-sm text-muted-foreground">
                Everything on this page is served from the module while still inheriting the host shell.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <section className="mt-6 grid gap-4 md:grid-cols-3">
        {module.highlights.map((item) => (
          <Card key={item}>
            <CardHeader>
              <CardTitle className="text-lg">Module highlight</CardTitle>
            </CardHeader>
            <CardContent>
