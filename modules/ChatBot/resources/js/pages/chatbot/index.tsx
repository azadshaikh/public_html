    ...
    >
      ...
      <section className="grid gap-4 xl:grid-cols-[1.35fr_1fr]">
        <Card className="border-none bg-gradient-to-br from-primary to-primary/80 text-primary-foreground shadow-none ring-0">
          <CardHeader>
            ...
            <CardDescription className="text-primary-foreground/75">
              Prompt templates are a good starting point for assistants, support
              flows, escalation agents, and knowledge-powered responses.
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Start simple, then grow into assistant orchestration.
            </CardDescription>
          </CardHeader>
            ...
            <CardContent className="p-6">
              <Empty>
                <EmptyHeader>
                  ...
                  <EmptyDescription>
                    Create a reusable system prompt to seed future assistants.
                  </EmptyDescription>
                </EmptyHeader>
                <EmptyContent>
                  <Button asChild>
      ...
      {prompts.prev_page_url || prompts.next_page_url ? (
        <div className="mt-6 flex items-center justify-between gap-4 text-sm text-muted-foreground">
          <span>
            Showing {prompts.from ?? 0} to {prompts.to ?? 0} of {prompts.total}{' '}
            templates
          </span>
          <div className="flex gap-2">
            <Button
            ...
            >
              <Link href={prompts.prev_page_url ?? chatbotIndexUrl}>
                Previous
              </Link>
            </Button>
            <Button
