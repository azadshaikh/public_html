      ...
      <Card>
        ...
        <CardContent className="grid gap-6 lg:grid-cols-2">
          <div className="space-y-5 lg:col-span-2">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium" htmlFor="system_prompt">
                System prompt
              </label>
              <Textarea
                id="system_prompt"
          ...
          <div className="flex items-start gap-3 rounded-xl border p-4 lg:col-span-2">
            ...
            <div className="space-y-1">
              <label className="text-sm font-medium" htmlFor="is_default">
                Set as default template
              </label>
              <p className="text-sm text-muted-foreground">
                Default templates are a good starting point for assistants,
                support bots, or agent presets.
              </p>
            </div>
          </div>
